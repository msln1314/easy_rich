...
class EmailSender:
    ...
    async def __get_settings(self, retry: int = 3):
        ...
        self.email = self.web_email.get("email_access")
        self.password = self.web_email.get("email_password")
        self.smtp_server = self.web_email.get("email_server")
        self.smtp_port = int(self.web_email.get("email_port"))
