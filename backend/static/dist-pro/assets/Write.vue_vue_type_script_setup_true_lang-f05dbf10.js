import { u as e, F as n } from "./useForm-b6ceb895.js";
...
import { E as V } from "./el-input-38d674e5.js";
import "./el-popper-09548d54.js";
/* empty css                   */ import {
  E as C,
  a as R,
} from "./el-tab-pane-1bfe2fef.js";
import { a as E, E as S } from "./el-pagination-491dd0e9.js";
/* empty css               */ import "./el-select-8805ff65.js";
const D = {
    name: "Element Plus",
    prefix: "ep",
    icons: [
    ...
    i({
      ...
      setup(e) {
        const n = async (e) => {
            ...
            (await u(), (K.value = Math.ceil((i + 1) / o(J))));
          },
          t = a(e, "modelValue"),
          i = l(),
          ...
          T = [D, U, F],
          W = r(T[0].prefix),
          B = g(() => T.findIndex((e) => e.prefix === o(W))),
          H = () => {
            K.value = 1;
          },
          J = r(49),
                      ...
                      b("div", M, [
                        h(
                          o(E),
                          {
                            ...
                            total: Q(T[B.value].icons).length,
                          },
                          null,
                          8,
    ...
    setup(i, { expose: d }) {
      ...
      return (
        ...
        (e, t) => (
          ...
          y(
            o(n),
            { rules: g, onRegister: o(r), schema: l, labelWidth: 100 },
            null,
            8,
