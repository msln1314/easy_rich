...
import { a as V, E as W } from "./el-select-8805ff65.js";
import { i as X } from "./isEqual-b8d86c27.js";
import { E as Y } from "./el-input-38d674e5.js";
import { b as D, u as G, E as Q } from "./el-popper-09548d54.js";
import { d as Z } from "./dropdown-84a04b2c.js";
            ...
            e.prevText
              ...
              : (r(),
                o(
                  d(c),
                  { key: 1 },
                  { default: p(() => [(r(), o(u(e.prevIcon)))]), _: 1 },
                )),
          ],
          8,
          ne,
  ...
  t({
    ...
    setup(e) {
      const a = e,
        ...
        g = l(
          () =>
            a.disabled || a.currentPage === a.pageCount || 0 === a.pageCount,
        );
      return (e, a) => (
        r(),
        s(
            ...
            e.nextText
              ...
              : (r(),
                o(
                  d(c),
                  { key: 1 },
                  { default: p(() => [(r(), o(u(e.nextIcon)))]), _: 1 },
                )),
          ],
          8,
          oe,
  ...
  t({
    ...
    setup(e, { emit: a }) {
      ...
      function v(e) {
        ...
        e !== g.value &&
          ((g.value = e),
          null == (a = c.handleSizeChange) || a.call(c, Number(e)));
      }
      return (e, a) => (
        r(),
        s(
                      ...
                      (e) => (
                        ...
                        o(
                          d(V),
                          {
                            key: e,
                            value: e,
                            label: e + d(i)("el.pagination.pagesize"),
                          },
                          null,
                          8,
                          ["value", "label"],
    ...
    setup(e, { emit: a }) {
      ...
      return (
        ...
        (e, a) => (
          ...
          s(
            "ul",
            { class: z(d(p).b()), onClick: U, onKeyup: j(q, ["enter"]) },
            [
              e.pageCount > 0
                ? (r(),
                  s(
                    "li",
                    {
                      ...
                      class: z([
                        [
                          d(p).is("active", 1 === e.currentPage),
                          d(p).is("disabled", e.disabled),
                        ],
                        "number",
                      ]),
                      "aria-current": 1 === e.currentPage,
                      "aria-label": d(c)("el.pagination.currentPage", {
                        pager: 1,
                      }),
                      tabindex: d(A),
                    },
                ...
                ? (r(),
                  s(
                    "li",
                    {
                      ...
                      class: z(d(S)),
                      tabindex: d(A),
                      "aria-label": d(c)("el.pagination.prevPages", {
                        pager: e.pagerCount - 2,
                      }),
                      onMouseenter: a[0] || (a[0] = (e) => I(!0)),
                      onMouseleave: a[1] || (a[1] = (e) => (v.value = !1)),
                      onFocus: a[2] || (a[2] = (e) => M(!0)),
                ...
                ? (r(),
                  s(
                    "li",
                    {
                      ...
                      class: z(d(B)),
                      tabindex: d(A),
                      "aria-label": d(c)("el.pagination.nextPages", {
                        pager: e.pagerCount - 2,
                      }),
                      onMouseenter: a[4] || (a[4] = (e) => I()),
...
const qe = L(
    t({
      ...
      setup(e, { emit: a, slots: t }) {
        const { t: r } = n(),
          ...
          i = M().vnode.props || {},
          o =
            "onUpdate:currentPage" in i ||
            "onUpdate:current-page" in i ||
            "onCurrentChange" in i,
          p =
            "onUpdate:pageSize" in i ||
            "onUpdate:page-size" in i ||
            "onSizeChange" in i,
          u = l(() => {
        ...
        function k(e, a) {
          e &&
            (e.props || (e.props = {}),
            (e.props.class = [e.props.class, a].join(" ")));
        }
        return (
          C(b, (e) => {
            v.value > e && (v.value = e);
          ...
          () => {
            var a, n;
            if (!u.value)
              return (U(Me, r("el.pagination.deprecationWarning")), null);
            ...
            const l = [],
              ...
              p = {
                ...
                slot:
                  null !=
                  (n =
                    null == (a = null == t ? void 0 : t.default)
                      ? void 0
                      : a.call(t))
                    ? n
                    : null,
  ...
  Ue = e({
    ...
    enterable: { ...G.enterable, default: !0 },
    effect: { ...G.effect, default: "light" },
              ...
              content: p(() => [
                e.title
                  ? (r(),
                    s(
                      "div",
                      { key: 0, class: z(d(c).e("title")), role: "title" },
                      i(e.title),
                      3,
                    ))
                  : w("v-if", !0),
