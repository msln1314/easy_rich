...
import { u as C, E as $ } from "./el-popper-09548d54.js";
const z = e({
    title: String,
    ...
    s({
      ...
      setup(e, { emit: t }) {
        const o = e,
          ...
          E = () => {
            var e, t;
            null == (t = null == (e = w.value) ? void 0 : e.onClose) ||
              t.call(e);
          },
          C = r(() => ({ width: c(o.width) })),
          z = (e) => {
          ...
          N = r(
            () => o.confirmButtonText || n("el.popconfirm.confirmButtonText"),
          ),
          j = r(
            () => o.cancelButtonText || n("el.popconfirm.cancelButtonText"),
          );
        return (e, t) => (
          i(),
          f(
