...
import { a as y } from "./scroll-6dba6951.js";
import { P as m } from "./vnode-34f6d346.js";
/**
 * @vue/shared v3.4.13
  ...
  for (const n of e.keys())
    if (e.get(n) === n._trackId) {
      if (n._dirtyLevel < t) {
        ...
        ((n._dirtyLevel = t),
          0 === e && ((n._shouldSchedule = !0), n.trigger()));
      }
      n.scheduler &&
        n._shouldSchedule &&
      ...
      M &&
        ...
        (function (e, t, s) {
          if (t.get(e) !== e._trackId) {
            ...
            s !== t
              ? (s && x(s, e), (e.deps[e._depsLength++] = t))
              : e._depsLength++;
          }
        })(
          L,
...
const P = (l, a = {}) => {
    e(l) ||
      t("[useLockscreen]", "You need to pass a ref param to this function");
    const h = a.ns || s("popup"),
      p = (function (e, t, s = !1) {
        let n, o;
        const i = "function" == typeof e;
        return (
          i ? ((n = e), (o = g)) : ((n = e.get), (o = e.set)),
          new O(n, o, i || !o, s)
        );
      })(() => h.bm("parent", "hidden"));
