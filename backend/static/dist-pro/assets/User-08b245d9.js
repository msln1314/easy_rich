...
import { E as c, a as y } from "./el-col-b8aa0d1a.js";
import { E as b } from "./el-skeleton-item-298f4c82.js";
import { E as g, a as v } from "./el-radio-group-0c46635e.js";
import { E as f } from "./el-date-picker-91f17f23.js";
import "./el-input-38d674e5.js";
import "./el-popper-09548d54.js";
import { _ as h } from "./Echart.vue_vue_type_script_setup_true_lang-5c4679ac.js";
...
const { t: _ } = a(),
  ...
  k = () => e.get({ url: "/analysis/random/number" }),
  ...
  G = { class: "border-1 border-[#e4e7ed] b-solid p-[20px] rounded-[4px]" },
  ...
  U = d("div", { class: "text-[#787a7d] text-[12px]" }, "支付成功客户数", -1),
  C = { class: "text-[#121315] text-[20px] mt-[10px]" },
  F = { class: "border-1 border-[#e4e7ed] b-solid p-[20px] rounded-[4px]" },
  H = d("div", { class: "text-[#000] text-[12px]" }, "会员分布情况", -1),
  I = { class: "border-1 border-[#e4e7ed] b-solid p-[20px] rounded-[4px]" },
  M = d("div", { class: "text-[#000] text-[12px]" }, "新增客户趋势", -1),
  N = { class: "border-1 border-[#e4e7ed] b-solid p-[20px] rounded-[4px]" },
  B = d("div", { class: "text-[#000] text-[12px]" }, "客户转会员趋势", -1),
  J = { class: "border-1 border-[#e4e7ed] b-solid p-[20px] rounded-[4px]" },
  K = d("div", { class: "text-[#000] text-[12px]" }, "支付成功客户趋势", -1),
  Q = { class: "border-1 border-[#e4e7ed] b-solid p-[20px] rounded-[4px]" },
  R = d("div", { class: "text-[#000] text-[12px]" }, "客户转会员趋势", -1),
                  ...
                  },
                  {
                    default: r(() => [
                      ...
                      n(
                        u(g),
                        { label: "3" },
                        { default: r(() => [p("最近7天")]), _: 1 },
                      ),
                      n(
                        u(g),
                        { label: "4" },
                        { default: r(() => [p("最近30天")]), _: 1 },
                      ),
                      n(
                        u(f),
                        {
                      ...
                      { xs: 24, sm: 6, class: "mb-2" },
                      {
                        default: r(() => [
                          n(
                            ...
                            {
                              default: r(() => [
                                d("div", T, [z, d("div", A, m(ta.value), 1)]),
                              ]),
                              _: 1,
                            },
                            8,
                      ...
                      { xs: 24, sm: 6, class: "mb-2" },
                      {
                        default: r(() => [
                          n(
                            ...
                            {
                              default: r(() => [
                                d("div", D, [V, d("div", q, m(la.value), 1)]),
                              ]),
                              _: 1,
                            },
                            8,
                      ...
                      { xs: 24, sm: 6, class: "mb-2" },
                      {
                        default: r(() => [
                          n(
                            ...
                            {
                              default: r(() => [
                                d("div", G, [L, d("div", O, m(ia.value), 1)]),
                              ]),
                              _: 1,
                            },
                            8,
                      ...
                      { xs: 24, sm: 6, class: "mb-2" },
                      {
                        default: r(() => [
                          n(
                            ...
                            {
                              default: r(() => [
                                d("div", P, [U, d("div", C, m(oa.value), 1)]),
                              ]),
                              _: 1,
                            },
                            8,
