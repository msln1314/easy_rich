...
import { u as b } from "./el-overlay-2c5c0104.js";
const B = e({
    center: Boolean,
    alignCenter: Boolean,
    closeIcon: { type: o },
  ...
  F = (e, o) => {
    ...
    const w = c("namespace", y),
      A = r(() => {
        ...
        return (
          e.fullscreen ||
            (e.top && (o[`${l}-margin-top`] = e.top),
            e.width && (o[`${l}-width`] = d(e.width))),
          o
        );
      }),
    ...
    return (
      ...
      }),
      {
        ...
        onFocusoutPrevented: function (e) {
          var o;
          "pointer" === (null == (o = e.detail) ? void 0 : o.focusReason) &&
            e.preventDefault();
        },
        titleId: g,
        bodyId: D,
