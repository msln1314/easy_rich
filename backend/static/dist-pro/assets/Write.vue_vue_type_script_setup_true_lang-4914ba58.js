...
import { g as a } from "./client_group-caf4c37c.js";
...
const u = s({
  ...
  setup(s, { expose: u }) {
    ...
    const h = r([
      ...
      { formRegister: S, formMethods: T } = e(),
      { setValues: R, getFormData: x, getElFormExpose: E } = T;
    return (
      c(
        () => y.currentRow,
        (e) => {
      ...
      (e, o) => (
        d(),
        m(i(t), { rules: j, onRegister: i(S), schema: h }, null, 8, [
          "rules",
          "onRegister",
          "schema",
        ])
