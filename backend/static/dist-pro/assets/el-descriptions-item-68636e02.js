import { g as e, f as l } from "./vnode-34f6d346.js";
import {
  e as t,
  ao as s,
  h as a,
  ...
  render() {
    ...
    const p = e(this.cell),
      ...
      m =
        (null ==
        (s =
          null == (t = null == (l = this.cell) ? void 0 : l.children)
            ? void 0
            : t.label)
          ? void 0
          : s.call(t)) || p.label,
      b =
        null ==
        (c =
          null == (o = null == (i = this.cell) ? void 0 : i.children)
            ? void 0
            : o.default)
          ? void 0
          : c.call(o),
...
const C = i({ row: { type: Array, default: () => [] } }),
  I = { key: 1 },
    ...
    t({
      ...
      setup(e) {
        ...
        const i = k(() => [s.b(), s.m(a.value)]),
          ...
          v = () => {
            var e;
            const s = l(null == (e = r.default) ? void 0 : e.call(r)).filter(
                (e) => {
                  var l;
                  return (
                    "ElDescriptionsItem" ===
                    (null == (l = null == e ? void 0 : e.type)
                      ? void 0
                      : l.name)
                  );
                },
            ...
            return (
              s.forEach((e, l) => {
                ...
                if (
                  (l < s.length - 1 && (o += c > i ? i : c), l === s.length - 1)
                ) {
                  ...
                  p(
                    ...
                    [
                      u(
                        "div",
                        { class: w(o(s).e("title")) },
                        [x(e.$slots, "title", {}, () => [$(N(e.title), 1)])],
                        2,
                      ),
                      u(
                        "div",
                        { class: w(o(s).e("extra")) },
                        [x(e.$slots, "extra", {}, () => [$(N(e.extra), 1)])],
                        2,
                      ),
                    ],
                    2,
...
const R = D(M, { DescriptionsItem: O }),
  G = j(O);
