...
import { u as x } from "./dict-2254259d.js";
...
var w =
  ...
  k = {
    ...
    mounted: function () {
      this.$refs.itemRef.offsetHeight > this.$refs.holderRef.offsetHeight &&
        (this.canExtend = !0);
    },
    methods: {
      toggle: function () {
        ...
        686: function (e, t, n) {
          ...
          var f = function () {
            ...
            if (void 0 !== i) {
              ...
              if (
                "cut" === n &&
                (i.hasAttribute("readonly") || i.hasAttribute("disabled"))
              )
                throw new Error(
  ...
  z = {
    ...
    mounted: function () {
      ...
      this.boxed &&
        this.$refs.jsonBox &&
        (this.onResized(),
        this.$refs.jsonBox.$el.addEventListener("resized", this.onResized, !0)),
      this.copyable) &&
        ...
        d.copyable
          ? (o(),
            i(
              ...
              {
                key: 0,
                class: r("jv-tooltip ".concat(v.copyText.align || "right")),
              },
              [
                s(
                  "span",
                  {
                    ref: "clip",
                    class: r(["jv-button", { copied: h.copied }]),
                  },
                  [
              ...
              "div",
              {
                ...
                onClick:
                  ...
                  (t[0] = function () {
                    return (
                      v.toggleExpandCode &&
                      v.toggleExpandCode.apply(v, arguments)
                    );
                  }),
              },
              [
                s(
                  "span",
                  { class: r(["jv-toggle", { open: !!h.expandCode }]) },
                  null,
                  2,
                ),
              ],
...
const L = d({
  ...
  setup(t) {
    ...
    const r = h([
      ...
      { field: "phone", label: "手机号", span: 24 },
      {
        ...
        slots: {
          default: (e) =>
            p(v, null, [
              p(g, { value: e.status, size: "small", disabled: !0 }, null),
            ]),
        },
      },
      {
        ...
        slots: {
          default: (e) =>
            p(v, null, [p("div", null, [b(n.value, e.platform)])]),
        },
      },
      {
        field: "login_method",
        ...
        slots: {
          default: (e) =>
            p(v, null, [p("div", null, [b(i.value, e.login_method)])]),
        },
      },
    ...
    return (n, i) => (
      o(),
      y(m(e), { schema: r, data: t.currentRow || {} }, null, 8, [
        "schema",
        "data",
      ])
    );
