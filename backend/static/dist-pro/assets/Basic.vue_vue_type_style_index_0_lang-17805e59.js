...
import { E as y } from "./el-progress-31e0b945.js";
import { u as I } from "./useValidator-63200dcb.js";
const P = o({
  __name: "Basic",
  ...
  setup(o) {
    const s = o,
                  ...
                  },
                  {
                    default: () => [
                      e.web_logo
                        ? i(
                            "img",
                            { src: e.web_logo, class: "logo-image" },
                            null,
                          )
                        : i(
                            r,
            ...
            slots: {
              default: () =>
                i(m, null, [
                  i(
                    c,
                    { loading: E.value, type: "primary", onClick: M },
                    { default: () => [p("立即提交")] },
                  ),
                ]),
            },
      ...
      { setValues: G, getFormData: k, getElFormExpose: L } = F;
    let B = d({});
    const E = d(!1),
      M = async () => {
        const e = await L();
        if (await (null == e ? void 0 : e.validate())) {
          const e = await k();
          if (((E.value = !0), !e))
            return ((E.value = !1), u.error("未获取到数据"));
          try {
            const a = await g(e);
            if (a)
              return (
                ...
                O.setFooterContent(
                  a.data.web_copyright || "Copyright ©2022-present K",
                ),
