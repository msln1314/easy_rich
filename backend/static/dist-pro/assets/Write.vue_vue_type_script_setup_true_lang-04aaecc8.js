...
import { u as o } from "./useValidator-63200dcb.js";
import { u as s } from "./dict-2254259d.js";
import { e as a } from "./task-5807e24e.js";
import {
  e as r,
  L as l,
  w as p,
...
const c = r({
  ...
  setup(r, { expose: c }) {
      ...
      f = l([
        ...
        },
        {
          ...
          componentProps: {
            style: { width: "100%" },
            placeholder:
              "cron 表达式，六位或七位，分别表示秒、分钟、小时、天、月、星期几、年(可选)",
          },
    ...
    return (
      ...
      (e, o) => (
        n(),
        m(i(t), { onRegister: i(P), schema: f }, null, 8, [
          "onRegister",
          "schema",
        ])
      )
