...
class QueryParams:
    ...
    def dict(self, exclude: list[str] = None,include: list[str] = None) -> dict:
...
class Paging(QueryParams):
    ...
    列表分页
    """
    def __init__(self, page: int = 1, limit: int = 10, prop: str = None, order: str = None):
        super().__init__()
        self.page = page
        self.limit = limit
        self.v_order = order
        self.v_order_field = prop
