...
Revision ID: 145021461e7b
Revises: 
Create Date: 2024-01-14 22:49:39.747754
...
def upgrade():
    ...
    sa.Column('code', sa.String(length=50), nullable=False, comment='部门标识'),
    ...
    sa.Column('manager', sa.String(length=255), nullable=True, comment='负责人'),
    ...
    sa.ForeignKeyConstraint(['parent_id'], ['sys_dept.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    comment='部门表'
    )
    op.create_index(op.f('ix_sys_dept_code'), 'sys_dept', ['code'], unique=False)
    op.create_index(op.f('ix_sys_dept_name'), 'sys_dept', ['name'], unique=False)
    ...
    op.create_index(op.f('ix_sys_dict_type_dict_name'), 'sys_dict_type', ['dict_name'], unique=False)
    ...
    op.create_index(op.f('ix_sys_login_log_phone'), 'sys_login_log', ['phone'], unique=False)
    op.create_table('sys_menu',
    sa.Column('menu_name', sa.String(length=50), nullable=False, comment='名称'),
    ...
    sa.Column('code', sa.String(length=50), nullable=False, comment='权限字符'),
    ...
    op.create_table('sys_settings_tab',
    ...
    op.create_index(op.f('ix_sys_settings_tab_classify'), 'sys_settings_tab', ['classify'], unique=False)
    op.create_index(op.f('ix_sys_settings_tab_tab_name'), 'sys_settings_tab', ['tab_name'], unique=True)
    ...
    sa.Column('last_change_pwd', sa.DateTime(), nullable=True, comment='最近一次登录时间'),
    ...
    op.create_index(op.f('ix_sys_user_name'), 'sys_user', ['name'], unique=False)
    op.create_index(op.f('ix_sys_user_phone'), 'sys_user', ['phone'], unique=False)
    ...
    sa.Column('color_type', sa.String(length=50), nullable=True, comment='颜色类型'),
    sa.Column('status', sa.Boolean(), nullable=False, comment='字典状态，是否禁用'),
    ...
    op.create_index(op.f('ix_sys_dict_color_type'), 'sys_dict', ['color_type'], unique=False)
    op.create_index(op.f('ix_sys_dict_label'), 'sys_dict', ['label'], unique=False)
    op.create_index(op.f('ix_sys_dict_value'), 'sys_dict', ['value'], unique=False)
    op.create_table('sys_help_issue_category',
    ...
    sa.Column('delete_datetime', sa.DateTime(), nullable=True, comment='删除时间'),
    sa.Column('is_delete', sa.Boolean(), nullable=False, comment='是否软删除'),
    sa.ForeignKeyConstraint(['create_user_id'], ['sys_user.id'], ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('id'),
    comment='常见问题类别表'
    )
    op.create_index(op.f('ix_sys_help_issue_category_name'), 'sys_help_issue_category', ['name'], unique=False)
    op.create_index(op.f('ix_sys_help_issue_category_platform'), 'sys_help_issue_category', ['platform'], unique=False)
    op.create_table('sys_resource_images',
    ...
    sa.Column('delete_datetime', sa.DateTime(), nullable=True, comment='删除时间'),
    sa.Column('is_delete', sa.Boolean(), nullable=False, comment='是否软删除'),
    sa.ForeignKeyConstraint(['tab_id'], ['sys_settings_tab.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    comment='系统配置表'
    )
    op.create_index(op.f('ix_sys_setting_config_key'), 'sys_setting', ['config_key'], unique=True)
    op.create_table('sys_sms_send_log',
    ...
    sa.Column('phone', sa.String(length=11), nullable=False, comment='目标手机号'),
    sa.Column('remark', sa.String(length=255), nullable=True, comment='失败描述'),
    ...
    op.create_table('sys_help_issue',
    ...
    sa.Column('delete_datetime', sa.DateTime(), nullable=True, comment='删除时间'),
    sa.Column('is_delete', sa.Boolean(), nullable=False, comment='是否软删除'),
    sa.ForeignKeyConstraint(['category_id'], ['sys_help_issue_category.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['create_user_id'], ['sys_user.id'], ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('id'),
    comment='常见问题记录表'
    )
    op.create_index(op.f('ix_sys_help_issue_title'), 'sys_help_issue', ['title'], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_sys_help_issue_title'), table_name='sys_help_issue')
    op.drop_table('sys_help_issue')
    op.drop_table('sys_user_role')
    op.drop_table('sys_sms_send_log')
    op.drop_index(op.f('ix_sys_setting_config_key'), table_name='sys_setting')
    op.drop_table('sys_setting')
    op.drop_table('sys_role_menu')
    op.drop_table('sys_resource_images')
    op.drop_index(op.f('ix_sys_help_issue_category_platform'), table_name='sys_help_issue_category')
    op.drop_index(op.f('ix_sys_help_issue_category_name'), table_name='sys_help_issue_category')
    op.drop_table('sys_help_issue_category')
    op.drop_index(op.f('ix_sys_dict_value'), table_name='sys_dict')
    op.drop_index(op.f('ix_sys_dict_label'), table_name='sys_dict')
    op.drop_index(op.f('ix_sys_dict_color_type'), table_name='sys_dict')
    op.drop_table('sys_dict')
    op.drop_index(op.f('ix_sys_user_phone'), table_name='sys_user')
    op.drop_index(op.f('ix_sys_user_name'), table_name='sys_user')
    op.drop_table('sys_user')
    op.drop_index(op.f('ix_sys_settings_tab_tab_name'), table_name='sys_settings_tab')
    op.drop_index(op.f('ix_sys_settings_tab_classify'), table_name='sys_settings_tab')
    op.drop_table('sys_settings_tab')
    ...
    op.drop_index(op.f('ix_sys_login_log_phone'), table_name='sys_login_log')
    op.drop_table('sys_login_log')
    op.drop_index(op.f('ix_sys_dict_type_dict_type'), table_name='sys_dict_type')
    op.drop_index(op.f('ix_sys_dict_type_dict_name'), table_name='sys_dict_type')
    op.drop_table('sys_dict_type')
    op.drop_index(op.f('ix_sys_dept_name'), table_name='sys_dept')
