...
const ie = u(function (e, a) {
  ...
  ue = { [ae]: (e) => r(e) || c(e) || b(e), change: (e) => r(e) || c(e) || b(e) },
  de = Symbol('checkboxGroupContextKey'),
  re = (
    e,
    { model: a, isLimitExceeded: l, hasOwnLabel: n, isDisabled: o, isLabeledByFormItem: t }
  ) => {
    const i = v(de, void 0),
      { formItem: s } = f(),
      { emit: u } = k()
    ...
    const r = m(() => (null == i ? void 0 : i.validateEvent) || e.validateEvent)
    return (
      x(
        () => e.modelValue,
        () => {
    ...
    const { formItem: l } = f(),
        ...
        return {
          model: m({
            ...
            set(e) {
              ...
              o.value && L(e)
                ? ((t.value =
                    void 0 !== (null == (i = null == n ? void 0 : n.max) ? void 0 : i.value) &&
                    e.length > (null == n ? void 0 : n.max.value)),
                  !1 === t.value &&
                    (null == (s = null == n ? void 0 : n.changeEvent) || s.call(n, e)))
                : (l(ae, e), (a.value = e))
            }
          }),
          isGroup: o,
      ...
      })(e),
      {
        ...
        return {
          checkboxButtonSize: E(
            m(() => {
              var e
              return null == (e = null == n ? void 0 : n.size) ? void 0 : e.value
            }),
            { prop: !0 }
          ),
          isChecked: t,
      ...
      { isDisabled: c } = (({ model: e, isChecked: a }) => {
        const l = v(de, void 0),
          n = m(() => {
            var n, o
            const t = null == (n = null == l ? void 0 : l.max) ? void 0 : n.value,
        ...
        return {
          isDisabled: p(m(() => (null == l ? void 0 : l.disabled.value) || n.value)),
          isLimitDisabled: n
        }
      })({ model: n, isChecked: s }),
  ...
  ve = ['id', 'aria-hidden', 'name', 'tabindex', 'disabled', 'true-value', 'false-value'],
    ...
    setup(e) {
      ...
      return (e, a) => (
        ...
        D(
          ...
          { class: O(j(h)), 'aria-controls': e.indeterminate ? e.controls : null, onClick: j(b) },
          {
            default: N(() => [
              _(
                'span',
                ...
                [
                  ...
                  _('span', { class: O(j(v).e('inner')) }, null, 2)
                ],
                10,
                be
              ),
    ...
    setup(e) {
      const a = e,
        ...
        c = m(() => {
          var e, a, l, n
          const o =
            null != (a = null == (e = null == d ? void 0 : d.fill) ? void 0 : e.value) ? a : ''
          return {
            backgroundColor: o,
            borderColor: o,
            color:
              null != (n = null == (l = null == d ? void 0 : d.textColor) ? void 0 : l.value)
                ? n
                : '',
          ...
          [
            e.trueLabel || e.falseLabel
              ? G(
                  ...
                  U(
                    ...
                    {
                      key: 0,
                      'onUpdate:modelValue': a[0] || (a[0] = (e) => ($(s) ? (s.value = e) : null)),
              ...
              : G(
                  ...
                  U(
                    ...
                    {
                      key: 1,
                      'onUpdate:modelValue': a[4] || (a[4] = (e) => ($(s) ? (s.value = e) : null)),
                      class: O(j(r).be('button', 'original')),
                      type: 'checkbox',
                      name: e.name,
                      tabindex: e.tabindex,
            ...
            e.$slots.default || e.label
              ? (V(),
                U(
                  'span',
                  { key: 2, class: O(j(r).be('button', 'inner')), style: H(j(o) ? j(c) : void 0) },
...
var Be = Z(
  F({
    ...
    setup(e, { emit: a }) {
      ...
      return (
        W(de, {
          ...ie(X(l), ['size', 'min', 'max', 'disabled', 'validateEvent', 'fill', 'textColor']),
          modelValue: u,
          changeEvent: s
        }),
        x(
          () => l.modelValue,
          () => {
            l.validateEvent && (null == o || o.validate('change').catch((e) => g()))
          }
        ),
        (e, a) => {
          var l
          return (
            ...
            D(
              P(e.tag),
              {
                ...
                'aria-labelledby': j(i) ? (null == (l = j(o)) ? void 0 : l.labelId) : void 0
              },
              { default: N(() => [q(e.$slots, 'default')]), _: 3 },
              8,
