  ...
  D = (e, a) => {
    const l = n(),
      ...
      u = d({
        ...
        set(n) {
          ;(s.value ? o.changeEvent(n) : a && a(L, n), (l.value.checked = e.modelValue === e.label))
        }
      }),
...
var O = V(
  u({
    ...
    setup(e, { emit: a }) {
      const l = e,
        o = b('radio'),
        { radioRef: s, radioGroup: n, focus: r, size: d, disabled: i, modelValue: t } = D(l, a)
      function u() {
        _(() => a('change', t.value))
      }
      return (e, a) => {
        ...
        return (
          ...
          m(
            ...
            [
              ...
              c(
                'span',
                { class: k(g(o).e('label')), onKeydown: a[3] || (a[3] = R(() => {}, ['stop'])) },
...
var W = V(
  u({
    ...
    setup(e) {
      const a = e,
        l = b('radio'),
        { radioRef: o, focus: s, size: n, disabled: r, modelValue: i, radioGroup: t } = D(a),
        u = d(() => ({
          backgroundColor: (null == t ? void 0 : t.fill) || '',
          borderColor: (null == t ? void 0 : t.fill) || '',
          boxShadow: (null == t ? void 0 : t.fill) ? `-1px 0 0 0 ${t.fill}` : '',
              ...
              v(
                c(
                  'input',
                  {
                    ref_key: 'radioRef',
                    ref: o,
                    'onUpdate:modelValue': a[0] || (a[0] = (e) => (y(i) ? (i.value = e) : null)),
  ...
  u({
    ...
    setup(e, { emit: a }) {
      const l = e,
        ...
        r = n(),
        { formItem: i } = C(),
        { inputId: t, isLabeledByFormItem: u } = E(l, { formItemContext: i })
      G(() => {
      ...
      return (
        ...
        $(
          () => l.modelValue,
          () => {
            l.validateEvent && (null == i || i.validate('change').catch((e) => j()))
          }
        ),
        (e, a) => (
          p(),
