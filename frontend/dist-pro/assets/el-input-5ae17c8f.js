...
function de(e, a = 1, t) {
  ...
  ;(ie.setAttribute('style', `${r};${ue}`), (ie.value = e.value || e.placeholder || ''))
  let u = ie.scrollHeight
  const p = {}
  ;('border-box' === s ? (u += o) : 'content-box' === s && (u -= n), (ie.value = ''))
  const d = ie.scrollHeight - n
  if (i(a)) {
    let e = d * a
    ;('border-box' === s && (e = e + n + o), (u = Math.max(e, u)), (p.minHeight = `${e}px`))
  }
  if (i(t)) {
    let e = d * t
    ;('border-box' === s && (e = e + n + o), (u = Math.min(e, u)))
  }
  return ((p.height = `${u}px`), null == (l = ie.parentNode) || l.removeChild(ie), (ie = void 0), p)
}
const ce = u({
        ...
        const p = l,
          ...
          f = a(() => [
            ...
            ue.is('exceed', Ae.value),
            {
              ...
              [ue.m('suffix')]: c.suffix || p.suffixIcon || p.clearable || p.showPassword,
            ...
            return (
              ...
              }),
              {
                ...
                handleBlur: (e) => {
                  var a
                  ;(e.relatedTarget &&
                    (null == (a = p.value) ? void 0 : a.contains(e.relatedTarget))) ||
          ...
          Fe = a(() => (null == le ? void 0 : le.validateState) || ''),
          $e = a(() => Fe.value && k[Fe.value]),
          Be = a(() => (ge.value ? z : C)),
          Pe = a(() => [d.style, p.inputStyle]),
          _e = a(() => [p.inputStyle, we.value, { resize: p.resize }]),
          je = a(() => (te(p.modelValue) ? '' : String(p.modelValue))),
          Me = a(
            () => p.clearable && !ie.value && !p.readonly && !!je.value && (ze.value || xe.value)
          ),
          Re = a(
            () =>
              p.showPassword && !ie.value && !p.readonly && !!je.value && (!!je.value || ze.value)
          ),
          Ve = a(
            () =>
              p.showWordLimit &&
          ...
          [He, Oe] = (function (e) {
            ...
            return [
              function () {
                ...
                const { selectionStart: t, selectionEnd: l, value: n } = e.value
        ...
        const Ke = () => {
          ...
          We = ((e) => {
            ...
            return () => {
              ...
              null === (null == (t = ve.value) ? void 0 : t.offsetParent) || (e(), (a = !0))
            }
          })(Ke),
          Le = () => {
            const e = Se.value,
          ...
          qe = async (e) => {
            ...
            ;(p.formatter && (a = p.parser ? p.parser(a) : a),
              be.value ||
                (a !== je.value ? (u(ae, a), u('input', a), await E(), Le(), Oe()) : Le()))
          },
          Ue = (e) => {
          ...
          Ge = async () => {
            var e
            ;(await E(), null == (e = Se.value) || e.focus())
          },
          Qe = (e) => {
                        ...
                        [
                          ...
                          e.$slots.prepend
                            ? (j(),
                              M(
                                'div',
                                { key: 0, class: N(A(ue).be('group', 'prepend')) },
                                [T(e.$slots, 'prepend')],
                                2
                              ))
                            : R('v-if', !0),
                          H(
                            ...
                            [
                                        ...
                                        [
                                          ...
                                          e.prefixIcon
                                            ? (j(),
                                              O(
                                                A(L),
                                                { key: 0, class: N(A(ue).e('icon')) },
                                                {
                                                  default: K(() => [(j(), O(W(e.prefixIcon)))]),
                                                  _: 1
                                                },
                                                8,
                                                ['class']
                              ...
                              H(
                                'input',
                                q(
                                  { id: A(oe), ref_key: 'input', ref: ce, class: A(ue).e('inner') },
                                  A(Q),
                                  {
                                    type: e.showPassword
                                      ? ge.value
                                    ...
                                    onCompositionend: Je,
                                    onInput: qe,
                                    onFocus: a[0] || (a[0] = (...e) => A(Ce) && A(Ce)(...e)),
                                    onBlur: a[1] || (a[1] = (...e) => A(Ie) && A(Ie)(...e)),
                                    onChange: Ue,
                                    onKeydown: ea
                                  }
                                ),
                                        ...
                                        [
                                          ...
                                          A(Me)
                                            ? (j(),
                                              O(
                                                ...
                                                {
                                                  key: 1,
                                                  class: N([A(ue).e('icon'), A(ue).e('clear')]),
                                                  onMousedown: D(A(J), ['prevent']),
                                                  onClick: aa
                                                },
                                                { default: K(() => [U(A(Y))]), _: 1 },
                                                8,
                                          ...
                                          A(Re)
                                            ? (j(),
                                              O(
                                                ...
                                                {
                                                  key: 2,
                                                  class: N([A(ue).e('icon'), A(ue).e('password')]),
                                                  onClick: Ze
                                                },
                                                { default: K(() => [(j(), O(W(A(Be))))]), _: 1 },
                                                8,
                                                ['class']
                                              ))
                                            : R('v-if', !0),
                                          A(Ve)
                                            ? (j(),
                                              M(
                                                'span',
                                                { key: 3, class: N(A(ue).e('count')) },
                                                [
                                                  H(
                                                    'span',
                                                    { class: N(A(ue).e('count-inner')) },
                                              ...
                                              O(
                                                A(L),
                                                {
                                                  ...
                                                  class: N([
                                                    A(ue).e('icon'),
                                                    A(ue).e('validateIcon'),
                                                    A(ue).is('loading', 'validating' === A(Fe))
                                                  ])
                                                },
                                                { default: K(() => [(j(), O(W(A($e))))]), _: 1 },
                                                8,
                                                ['class']
                                              ))
                                            : R('v-if', !0)
                          ...
                          e.$slots.append
                            ? (j(),
                              M(
                                'div',
                                { key: 1, class: N(A(ue).be('group', 'append')) },
                                [T(e.$slots, 'append')],
                                2
                              ))
                            : R('v-if', !0)
                      ...
                      M(
                        ...
                        [
                          ...
                          H(
                            'textarea',
                            q(
                              { id: A(oe), ref_key: 'textarea', ref: ve, class: A(pe).e('inner') },
                              A(Q),
                              {
                                tabindex: e.tabindex,
                                disabled: A(ie),
                                ...
                                onCompositionend: Je,
                                onInput: qe,
                                onFocus: a[2] || (a[2] = (...e) => A(Ce) && A(Ce)(...e)),
                                onBlur: a[3] || (a[3] = (...e) => A(Ie) && A(Ie)(...e)),
                                onChange: Ue,
                                onKeydown: ea
                              }
                            ),
                          ...
                          A(Ve)
                            ? (j(),
                              M(
                                'span',
                                { key: 0, style: G(he.value), class: N(A(ue).e('count')) },
                                Z(A(Ne)) + ' / ' + Z(A(Q).maxlength),
                                7
                              ))
                            : R('v-if', !0)
