...
import { E as re } from './el-message-box-faa52860.js'
import { u as ae } from './el-input-5ae17c8f.js'
import './el-overlay-34b9d092.js'
import { a as ie, E as le } from './el-table-column-36e57984.js'
import { E as se } from './el-checkbox-77b6829c.js'
import './el-tooltip-4ed993c7.js'
import { E as ce } from './el-popper-797844d6.js'
/* empty css               */ import { E as ue, a as de } from './el-pagination-60eda460.js'
import './el-select-38080147.js'
import { E as fe } from './el-image-viewer-73f400a0.js'
import { i as pe, g as he } from './useForm-c59a8d29.js'
import { a as ve, E as ge, b as me } from './el-dropdown-item-a41cbdee.js'
/* empty css                   */ import { E as be } from './el-divider-9c19755b.js'
import {
  _ as ye,
  e as we,
  k as Se,
...
import { g as Ye } from './scroll-ac7d0423.js'
const Ue = e({
...
const qe = k(
      ...
      r({
        ...
        setup(e, { emit: t }) {
          ...
          const { t: r } = a(),
            ...
            z = s(),
            B = s(),
            L = u && 'loading' in HTMLImageElement.prototype
          let X, Y
          const U = c(() => [C.e('inner'), W.value && C.e('preview'), R.value && C.is('loading')]),
            H = c(() => k.style),
            V = c(() => {
              const { fit: e } = n
            ...
            q = c(() => 'eager' !== n.loading && ((!L && 'lazy' === n.loading) || n.lazy)),
            G = () => {
              u && ((R.value = !0), (M.value = !1), (N.value = n.src))
            }
          function K(e) {
          ...
          async function ee() {
            ...
            ;(T(t)
              ? (B.value = t)
              : j(t) && '' !== t
                ? (B.value = null != (e = document.querySelector(t)) ? e : void 0)
                : z.value && (B.value = Ye(z.value)),
              B.value && ((X = A(B, 'scroll', Q)), setTimeout(() => Z(), 100)))
          }
          function te() {
            u && B.value && Q && (null == X || X(), (B.value = void 0))
          }
          function ne(e) {
          ...
          function re() {
            ;(null == Y || Y(), (document.body.style.overflow = o), (F.value = !1), t('close'))
          }
          function ie(e) {
            t('switch', e)
          }
                ...
                [
                  M.value
                    ? v(e.$slots, 'error', { key: 0 }, () => [
                        g('div', { class: y(b(C).e('error')) }, m(b(r)('el.image.error')), 3)
                      ])
                    : (p(),
                      h(
                        w,
                              ...
                              h(
                                ...
                                [
                                  v(e.$slots, 'placeholder', {}, () => [
                                    g('div', { class: y(b(C).e('placeholder')) }, null, 2)
                                  ])
                                ],
                                2
                              ))
  ...
  Ke = (e) => {
      ...
      p = {
        ...
        delList: async (t, n = [], i = !0) => {
          ...
          if (N(n)) {
            ...
            if (!((null == (l = b(c)) ? void 0 : l.getSelectionRows().length) > 0))
              return void M.warning(Ge('common.delNoData'))
            f = null == (s = b(c)) ? void 0 : s.getSelectionRows().map((e) => e.id)
          } else f = n
          const h = () => {
            M.success(Ge('common.delSuccess'))
            const e = R(f) ? f.length : 1,
              t = (b(a) % b(r) === e || 1 === b(r)) && b(o) > 1 ? b(o) - 1 : b(o)
            ;((o.value = t), p.getList())
          }
          if (i)
        ...
        getSelections: async () => {
          var e
          return (await u(), (null == (e = b(c)) ? void 0 : e.getSelectionRows()) || [])
        },
    ...
    return {
      ...
      tableMethods: p,
      tableState: { currentPage: o, pageSize: r, total: a, dataList: i, loading: n }
    }
  }
var Je = Object.defineProperty,
  ...
  ot = (e, t) => {
    ...
    if (null != e && Ze) for (var o of Ze(e)) t.indexOf(o) < 0 && et.call(e, o) && (n[o] = e[o])
    return n
  }
function rt(e, t, n) {
...
function Dt(e, t, n, o) {
  if (e) {
    ...
    do {
      if (
        (null != t && ('>' === t[0] ? e.parentNode === n && Et(e, t) : Et(e, t))) ||
        (o && e === n)
      )
        return e
      if (e === n) break
...
function Tt(e, t, n) {
  if (e && t)
    if (e.classList) e.classList[n ? 'add' : 'remove'](t)
      ...
      var o = (' ' + e.className + ' ').replace(_t, ' ').replace(' ' + t + ' ', ' ')
    ...
    if (
      ...
      do {
        if (
          ...
          ('none' !== jt(r, 'transform') || (n && 'static' !== jt(r, 'position')))
        ) {
...
function Ft(e, t) {
  ...
  for (; (e = e.previousElementSibling); )
    'TEMPLATE' !== e.nodeName.toUpperCase() && e !== Un.clone && (!t || Et(e, t)) && n++
  return n
}
function zt(e) {
  var t = 0,
    ...
    initializePlugins: function (e, t, n, o) {
      for (var r in (Wt.forEach(function (o) {
        ...
        if (e.options[r] || o.initializeByDefault) {
          ...
          ;((a.sortable = e), (a.options = e.options), (e[r] = a), dt(n, a.defaults))
        }
      }),
      e.options))
...
var Zt,
  ...
  Fn = function (e, t) {
    var n = jt(e),
      ...
      i = r && jt(r),
      l = a && jt(a),
      s = i && parseInt(i.marginLeft) + parseInt(i.marginRight) + Pt(r).width,
      c = l && parseInt(l.marginLeft) + parseInt(l.marginRight) + Pt(a).width
    if ('flex' === n.display)
...
function Un(e, t) {
  ...
  for (var o in (qt.initializePlugins(this, e, n), n)) !(o in t) && (t[o] = n[o])
  ...
  ;((this.nativeDraggable = !t.forceFallback && Mn),
    ...
    t.supportPointer
      ...
      : (St(e, 'mousedown', this._onTapStart), St(e, 'touchstart', this._onTapStart)),
...
;((Un.prototype = {
  ...
  _onTapStart: function (e) {
    if (e.cancelable) {
      ...
      if (
        ...
        !Zt &&
          !((/mousedown|pointerdown/.test(a) && 0 !== e.button) || o.disabled) &&
          !s.isContentEditable &&
          (this.nativeDraggable || !mt || !l || 'SELECT' !== l.tagName.toUpperCase()) &&
          !(((l = Dt(l, o.draggable, n, !1)) && l.animated) || on === l))
      ) {
        if (((ln = Ft(l)), (cn = Ft(l, o.draggable)), 'function' == typeof c)) {
          if (c.call(this, e, l, this))
            return (
              Jt({ sortable: t, rootEl: s, name: 'filter', targetEl: l, toEl: n, fromEl: n }),
              Kt('filter', t, { evt: e }),
          ...
          (c = c.split(',').some(function (o) {
            if ((o = Dt(s, o.trim(), n, !1)))
              return (
                Jt({ sortable: t, rootEl: o, name: 'filter', targetEl: l, fromEl: n, toEl: n }),
                Kt('filter', t, { evt: e }),
                !0
              )
          }))
        ...
        ;(o.handle && !Dt(s, o.handle, n, !1)) || this._prepareDragStart(e, i, l)
      }
    }
  },
  _prepareDragStart: function (e, t, n) {
    ...
    if (n && !Zt && n.parentNode === a) {
      ...
      if (
        ...
        (dn = i.group),
        (Un.dragged = Zt),
        (pn = { target: Zt, clientX: (t || e).clientX, clientY: (t || e).clientY }),
        ...
        gt && this.nativeDraggable && ((this.options.touchStartThreshold = 4), (Zt.draggable = !0)),
        Kt('delayStart', this, { evt: e }),
        !i.delay || (i.delayOnTouchOnly && !t) || (this.nativeDraggable && (vt || ht)))
      )
        o()
      else {
        ...
        ;(St(l, 'mouseup', r._disableDelayedDrag),
          ...
          i.supportPointer && St(l, 'pointermove', r._delayedDragTouchMoveHandler),
  ...
  _disableDelayedDrag: function () {
    ;(Zt && Vn(Zt), clearTimeout(this._dragStartTimer), this._disableDelayedDragEvents())
  },
  ...
  _dragStarted: function (e, t) {
    if (((On = !1), tn && Zt)) {
      ;(Kt('dragStarted', this, { evt: t }), this.nativeDraggable && St(document, 'dragover', Yn))
      var n = this.options
  ...
  _emulateDragOver: function () {
    if (hn) {
      ...
      for (
        ...
        e && e.shadowRoot && (e = e.shadowRoot.elementFromPoint(hn.clientX, hn.clientY)) !== t;
      )
        t = e
  ...
  _onTouchMove: function (e) {
    if (pn) {
      var t = this.options,
        ...
        l = en && a && a.d,
        s = Pn && En && zt(En),
        c = (r.clientX - pn.clientX + o.x) / (i || 1) + (s ? s[0] - jn[0] : 0) / (i || 1),
        u = (r.clientY - pn.clientY + o.y) / (l || 1) + (s ? s[1] - jn[1] : 0) / (l || 1)
      if (!Un.active && !On) {
  ...
  _appendGhost: function () {
    if (!en) {
      ...
      if (Pn) {
        for (
          En = e;
          'static' === jt(En, 'position') && 'none' === jt(En, 'transform') && En !== document;
        )
          En = En.parentNode
        ;(En !== document.body && En !== document.documentElement
          ? (En === document && (En = kt()), (t.top += En.scrollTop), (t.left += En.scrollLeft))
          : (En = kt()),
          (jn = zt(En)))
      }
      ;(Tt((en = Zt.cloneNode(!0)), n.ghostClass, !1),
        ...
        jt(en, 'opacity', '0.8'),
        jt(en, 'position', Pn ? 'absolute' : 'fixed'),
        jt(en, 'zIndex', '100000'),
        ...
        : (Kt('setupClone', this),
          ...
          t
            ...
            : (xt(document, 'mouseup', n._onDrop),
              ...
              o && ((o.effectAllowed = 'move'), r.setData && r.setData.call(n, o, Zt)),
              St(document, 'drop', n),
      ...
      if (
        ...
        c &&
          ...
          (u
            ? d || (o = Qt !== tn)
            : fn === this ||
              ((this.lastPutMode = dn.checkPull(this, c, Zt, e)) && s.checkPut(this, c, Zt, e))))
      ) {
        if (
        ...
        if (o)
          return (
            ...
            this._hideClone(),
            j('revert'),
            Un.eventCanceled || (nn ? tn.insertBefore(Zt, nn) : tn.appendChild(Zt)),
            I(!0)
          )
        ...
        if (
          !v ||
          ((function (e, t, n) {
            var o = Pt(Rt(n.el, n.options.draggable)),
              r = 10
            return t
              ? e.clientX > o.right + r ||
          ...
          if (
            ...
            return (
              A(),
              v && v.nextSibling ? a.insertBefore(Zt, v.nextSibling) : a.appendChild(Zt),
              (Qt = a),
              k(),
              I(!0)
            )
          ...
          v &&
          (function (e, t, n) {
            var o = Pt(Mt(n.el, 0, n.options, !0)),
              r = 10
            return t
          ...
          var g = Mt(a, 0, l, !0)
          if (g === Zt) return I(!1)
          if (((n = Pt((i = g))), !1 !== Hn(tn, a, Zt, t, i, n, e, !1)))
          ...
          var m,
            ...
            })((Zt.animated && Zt.toRect) || t, (i.animated && i.toRect) || n, r),
            x = r ? 'top' : 'left',
            E = Nt(i, 'top', 'top') || Nt(Zt, 'top', 'top'),
            O = E ? E.scrollTop : void 0
          if (
            (wn !== i && ((b = n[x]), (_n = !1), (Tn = (!S && l.invertSwap) || w)),
            (m = (function (e, t, n, o, r, a, i, l) {
              ...
              if (!i)
                if (l && xn < c * r) {
                  if (
                    (!_n && (1 === Sn ? s > u + (c * a) / 2 : s < d - (c * a) / 2) && (_n = !0), _n)
                  )
                    f = !0
              ...
              return (
                (f = f || i),
                f && (s < u + (c * a) / 2 || s > d - (c * a) / 2) ? (s > u + c / 2 ? 1 : -1) : 0
              )
            })(
              e,
              i,
          ...
          if (!1 !== T)
            return (
              ...
              setTimeout(Wn, 30),
              A(),
              _ && !C ? a.appendChild(Zt) : i.parentNode.insertBefore(Zt, _ ? C : i),
              E && Yt(E, 0, O - E.scrollTop),
              (Qt = Zt.parentNode),
              void 0 !== b && !Tn && (xn = Math.abs(b - Pt(i)[x])),
              k(),
              I(!0)
            )
        }
        ...
        st(
          {
            ...
            completed: I,
            onMove: function (n, o) {
              return Hn(tn, a, Zt, t, n, Pt(n), e, o)
            },
            changed: k
          },
          s
    ...
    function I(t) {
      return (
        ...
        t &&
          ...
          fn !== p && p !== Un.active ? (fn = p) : p === Un.active && fn && (fn = null),
        ...
        !l.dragoverBubble &&
          !e.rootEl &&
          i !== document &&
          (Zt.parentNode[Ht]._isOutsideThisEl(e.target), !t && Xn(e)),
  ...
  _offMoveEvents: function () {
    ;(xt(document, 'mousemove', this._onTouchMove),
      ...
      xt(document, 'dragover', Xn),
      xt(document, 'mousemove', Xn),
      xt(document, 'touchmove', Xn))
  },
  ...
  _onDrop: function (e) {
    ...
    ;((sn = Ft(Zt)),
      ...
      Un.eventCanceled ||
        ...
        this.nativeDraggable && (xt(document, 'drop', this), xt(t, 'dragstart', this._onDragStart)),
        this._offMoveEvents(),
        this._offUpEvents(),
        ...
        e &&
          ...
          Zt &&
            ...
            yn && !On && Tt(Zt, fn ? fn.options.ghostClass : this.options.ghostClass, !1),
            ...
            tn !== Qt
              ? (sn >= 0 &&
                  (Jt({ rootEl: Qt, name: 'add', toEl: Qt, fromEl: tn, originalEvent: e }),
                  Jt({ sortable: this, name: 'remove', toEl: Qt, originalEvent: e }),
                  Jt({ rootEl: Qt, name: 'sort', toEl: Qt, fromEl: tn, originalEvent: e }),
                  Jt({ sortable: this, name: 'sort', toEl: Qt, originalEvent: e })),
                fn && fn.save())
              : sn !== ln &&
                sn >= 0 &&
                (Jt({ sortable: this, name: 'update', toEl: Qt, originalEvent: e }),
                Jt({ sortable: this, name: 'sort', toEl: Qt, originalEvent: e })),
            Un.active &&
  ...
  toArray: function () {
    for (var e, t = [], n = this.el.children, o = 0, r = n.length, a = this.options; o < r; o++)
      Dt((e = n[o]), a.draggable, this.el, !1) && t.push(e.getAttribute(a.dataIdAttr) || $n(e))
    return t
  },
  sort: function (e, t) {
    var n = {},
  ...
  destroy: function () {
    ...
    ;((e[Ht] = null),
      ...
      this.nativeDraggable && (xt(e, 'dragover', this), xt(e, 'dragenter', this)),
  ...
  _hideClone: function () {
    if (!an) {
      ...
      ;(jt(rn, 'display', 'none'),
        this.options.removeCloneOnHide && rn.parentNode && rn.parentNode.removeChild(rn),
        (an = !0))
    }
  },
...
var io = Xt(function (e, t, n, o) {
    if (t.scroll) {
      var r,
        ...
        c = kt(),
        u = !1
      Jn !== n && ((Jn = n), ro(), (Kn = t.scroll), (r = t.scrollFn), !0 === Kn && (Kn = Bt(n, !0)))
      var d = 0,
        f = Kn
      do {
        var p = f,
        ...
        p === c
          ? ((S =
              y < E &&
              ('auto' === D.overflowX || 'scroll' === D.overflowX || 'visible' === D.overflowX)),
            (x =
              w < O &&
              ('auto' === D.overflowY || 'scroll' === D.overflowY || 'visible' === D.overflowY)))
          : ((S = y < E && ('auto' === D.overflowX || 'scroll' === D.overflowX)),
            (x = w < O && ('auto' === D.overflowY || 'scroll' === D.overflowY)))
        var T = S && (Math.abs(b - a) <= l && C + y < E) - (Math.abs(m - a) <= l && !!C),
          j = x && (Math.abs(g - i) <= l && _ + w < O) - (Math.abs(v - i) <= l && !!_)
          ...
          (0 != T || 0 != j) &&
            ...
            (no[d].pid = setInterval(
              function () {
                ...
                ;('function' == typeof r &&
                  'continue' !==
                    r.call(Un.dragged.parentNode[Ht], n, t, e, eo, no[this.layer].el)) ||
      ...
      return (
        (e.prototype = {
          ...
          _handleAutoScroll: function (e, t) {
            ...
            if (((eo = e), t || this.options.forceAutoScrollFallback || vt || ht || mt)) {
              ...
              if (!this.options.bubbleScroll || Bt(a, !0) === kt()) return void ro()
...
function po(...e) {
  var t, n
  const o = null == (t = L()) ? void 0 : t.proxy,
    r = e[0]
  let [, a, i] = e
  Array.isArray(b(a)) || ((i = a), (a = null))
  let l = null
  const { immediate: s = !0, clone: c = uo, customUpdate: u } = null != (n = b(i)) ? n : {}
  const p = {
    onUpdate: function (e) {
      if (u) return void u(e)
      const { from: t, item: n, oldIndex: o, oldDraggableIndex: r, newDraggableIndex: i } = e
    ...
    onRemove: function (e) {
      const { from: t, item: n, oldIndex: o, oldDraggableIndex: r, pullMode: i, clone: l } = e
...
const ho = [
  ...
  vo = r({
    ...
    setup(e, { slots: t, emit: n, expose: o }) {
      const r = l(),
        a = ho.reduce(
          (e, t) => ((e[`on${t.replace(/^\S/, (e) => e.toUpperCase())}`] = (e) => n(t, e)), e),
          {}
        ),
        i = c(() => {
          const t = F(e),
        ...
        u = c({ get: () => e.modelValue, set: (e) => n('update:modelValue', e) }),
        d = s(),
...
;((Fo = Vo),
  (Bo = Ce),
  (Lo = (zo = Vo.exports) && !zo.nodeType && zo),
  (Xo = Lo && Fo && !Fo.nodeType && Fo),
  (Yo = Xo && Xo.exports === Lo ? Bo.Buffer : void 0),
...
var ma = function e(t, n, o, r, a, i) {
    ...
    if (d) {
      ...
      if (f == va || f == pa || (p && !a)) {
        if (((l = c || p ? {} : aa(t)), !s)) return c ? Qr(t, Gr(l, t)) : Zr(t, qr(l, t))
      } else {
        if (!ga[f]) return a ? t : {}
        l = ra(t, f, s)
      }
...
function wa(e) {
  return (
    'function' == typeof e || ('[object Object]' === Object.prototype.toString.call(e) && !K(e))
  )
}
const Sa = J(),
  xa = c(() => Sa.sizeMap),
  ...
  _a = r({
    ...
    setup(e, { emit: t }) {
      ...
      if (void 0 === c) {
        const e = { field: '_serial_number', label: '序号', type: 'index', show: !1, disabled: !0 }
        'selection' === r.value[0].type ? r.value.splice(1, 0, e) : r.value.unshift(e)
      } else l.value = c.show
      const u = ya(b(r)),
        f = s(!1),
        p = s(!0),
      ...
      ;(d(
        ...
        async (e) => {
          ...
          ;(Ea(y, JSON.stringify(n)), v(), await _(), null == (t = a.value) || t.doLayout())
        },
        { deep: !0 }
      ),
        d(
      ...
      return (
        ...
        () =>
          W(w, null, [
            W('div', { class: 'text-right h-28px flex items-center justify-end' }, [
              W(
                ce,
              ...
              W(
                ...
                { content: Ca('common.columnSetting'), placement: 'top' },
                {
                  default: () => [
                    W(
                      ue,
                      { trigger: 'click', placement: 'bottom', width: '300px' },
                      {
                        default: () => {
                          let e, t, n, o
                          return W('div', null, [
                              ...
                              [
                                W('div', null, [
                                  W(
                                    ...
                                    wa((e = Ca('common.selectAll'))) ? e : { default: () => [e] }
                                  ),
                                  W(
                                    se,
                                    {
                                ...
                                W(
                                  ...
                                  wa((n = Ca('common.reset'))) ? n : { default: () => [n] }
                                )
                              ]
                            ),
                            W(
                              ...
                              { 'max-height': '400px' },
                              {
                                default: () => [
                                  W(
                                    vo,
                                    { modelValue: r.value, onEnd: x, handle: '.cursor-move' },
                                    wa(
                                      (o = r.value.map((e) =>
                                        'index' === e.type || 'selection' === e.type
                                          ? W('span', null, null)
                                          : W('div', { class: 'flex justify-between' }, [
                                              W('div', null, [
                                                W('span', { class: 'cursor-move mr-10px' }, [
                                                  W($, { icon: 'akar-icons:drag-vertical' }, null)
                                                ]),
                                                W(
                                                  se,
                                                  {
                                              ...
                                              W('div', { class: 'mt-7px mr-9px' }, [
                                                W(
                                                  'span',
                                                  {
                                                    class:
                                                      'left' === e.fixed ? 'color-[#409eff]' : '',
                                                    onClick: () => {
                                                      e.fixed = 'left' === e.fixed ? void 0 : 'left'
                                                    }
                                                  },
                                                  [
                                                    W(
                                                ...
                                                W(be, { direction: 'vertical' }, null),
                                                W(
                                                  'span',
                                                  {
                                                    class:
                                                      'right' === e.fixed ? 'color-[#409eff]' : '',
                                                    onClick: () => {
                                                      e.fixed =
                                                        'right' === e.fixed ? void 0 : 'right'
                                                    }
                                                  },
                                                  [
                                                    W(
...
const ja = J(),
  Aa = r({
    ...
    props: {
      ...
      align: H.string.validate((e) => ['left', 'center', 'right'].includes(e)).def('left'),
      headerAlign: H.string.validate((e) => ['left', 'center', 'right'].includes(e)).def('left'),
    ...
    setup(e, { attrs: t, emit: n, slots: o, expose: r }) {
        ...
        g = (e, t) => {
          ...
          for (const r of t || o)
            for (const t of e)
              r.field === t.field
                ? ne(r, t.path, t.value)
                : (null == (n = r.children) ? void 0 : n.length) && g(e, r.children)
        },
        m = () => {
          n('refresh')
        },
      ...
      const x = c(() => {
        ...
        E = (e) => {
          const { align: t, headerAlign: n, showOverflowTooltip: o, preview: r } = b(h)
          return e.map((e) => {
            var a
              ...
              s = {
                default: (...t) => {
                  ...
                  return (
                    ...
                    l && l.length
                      ? E(l)
                      : (null == (n = null == i ? void 0 : i.slots) ? void 0 : n.default)
                        ? i.slots.default(...t)
                        : (null == e ? void 0 : e.formatter)
                          ? null == (o = null == e ? void 0 : e.formatter)
                            ? void 0
                            : o.call(e, a.row, a.column, oe(a.row, e.field), a.$index)
                          : s
                            ? O(oe(a.row, e.field))
                            : oe(a.row, e.field)
                  )
            ...
            return (
              (null == (a = null == i ? void 0 : i.slots) ? void 0 : a.header) &&
                (s.header = (...e) => i.slots.header(...e)),
              W(
                le,
                S({ showOverflowTooltip: o, align: t, headerAlign: n }, i, { prop: e.field }),
                Ta(s) ? s : { default: () => [s] }
              )
            )
          })
                  ...
                  ((e) => {
                    ...
                    return (e || t).map((e) => {
                        ...
                        )
                      {
                            ...
                            default: (...t) => {
                              ...
                              return (
                                ...
                                o && o.length
                                  ? E(o)
                                  : (
                                        null == (r = null == n ? void 0 : n.slots)
                                          ? void 0
                                          : r.default
                                      )
                                    ? n.slots.default(...t)
                                    : (null == e ? void 0 : e.formatter)
                                      ? null == (a = null == e ? void 0 : e.formatter)
                                        ? void 0
                                        : a.call(e, i.row, i.column, oe(i.row, e.field), i.$index)
                                      : l
                                        ? O(oe(i.row, e.field))
                                        : oe(i.row, e.field)
                              )
                        ...
                        return (
                          (null == (t = null == n ? void 0 : n.slots) ? void 0 : t.header) &&
                            (r.header = (...e) => n.slots.header(...e)),
                          W(
                            le,
                            S({ showOverflowTooltip: l, align: a, headerAlign: i }, n, {
                              prop: e.field
                            }),
                            Ta(r) ? r : { default: () => [r] }
                          )
