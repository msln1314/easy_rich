...
import { E as qe } from './el-popper-797844d6.js'
import { f as De, a as We, t as Ge } from './tree-ae7cba8b.js'
import { t as Ze, u as Ke, F as Je } from './useForm-c59a8d29.js'
import { _ as Qe } from './index-55f4d4a6.js'
import { f as Ye } from './vnode-06a99f10.js'
import { i as Xe } from './isNil-1f22f7b0.js'
import { C as et } from './index-eb31d854.js'
import { E as tt, b as lt, a as at } from './el-dropdown-item-a41cbdee.js'
import { _ as ot } from './Footer.vue_vue_type_script_setup_true_lang-120f04e3.js'
import { T as nt, _ as rt } from './LocaleDropdown.vue_vue_type_script_setup_true_lang-290dde7d.js'
import { E as st } from './el-message-box-faa52860.js'
import { E as ut } from './el-input-5ae17c8f.js'
import './el-overlay-34b9d092.js'
import { a as it } from './avatar-d437f563.js'
import { _ as ct } from './Dialog.vue_vue_type_style_index_0_lang-ce349c68.js'
import { u as dt } from './useValidator-db15330d.js'
import { d as pt } from './dayjs.min-e5ba30ae.js'
import { E as vt } from './el-drawer-45b209ae.js'
import { E as mt } from './el-divider-9c19755b.js'
import { E as ht } from './el-switch-6f4f5b6a.js'
...
const yt = k(
          ...
          const k = r,
            ...
            { handleClick: I, visible: T } = ((r, s, u) => {
              const i = e(),
                ...
                d = t(!1),
                p = () => {
                  i.value && (d.value = i.value.scrollTop >= r.visibilityHeight)
                },
                v = n(p, 300, !0)
              return (
                l(c, 'scroll', v),
                a(() => {
                  ...
                  ;((c.value = document),
                    ...
                    r.target &&
                      ((i.value = null != (e = document.querySelector(r.target)) ? e : void 0),
                ...
                }),
                {
                  ...
                  handleClick: (e) => {
                    var t
                    ;(null == (t = i.value) || t.scrollTo({ top: 0, behavior: 'smooth' }),
                      s('click', e))
                  }
                }
              )
                    ...
                    ? (i(),
                      v(
                        'div',
                        {
                          ...
                          style: m(p($)),
                          class: h(p(M).b()),
                          onClick: t[0] || (t[0] = f((...e) => p(I) && p(I)(...e), ['stop']))
                        },
                        [
                          g(e.$slots, 'default', {}, () => [
                            x(
  ...
  _t = M({ separator: { type: String, default: '/' }, separatorIcon: { type: I } }),
              ...
              (null == (l = p(o)) ? void 0 : l.separatorIcon)
                ? (i(),
                  c(
                    ...
                    { default: d(() => [(i(), c(P(p(o).separatorIcon)))]), _: 1 },
                    8,
                    ['class']
                  ))
                : (i(),
                  v(
                    'span',
                    { key: 1, class: h(p(n).e('separator')), role: 'presentation' },
    ...
    setup() {
      ...
      return {
        listeners: {
          ...
          onEnter(t, l) {
            ;(E(t, `${e.namespace.value}-opacity-transition`), (t.style.opacity = '1'), l())
          },
          onAfterEnter(t) {
            ;(O(t, `${e.namespace.value}-opacity-transition`), (t.style.opacity = ''))
          },
          onBeforeLeave(t) {
            ;(t.dataset || (t.dataset = {}),
              R(t, e.m('collapse'))
...
var At = r({
  ...
  setup(e, { slots: l, expose: n }) {
    ...
    const x = t(!1),
      y = t(),
      w = t(null),
      _ = u(() => ('horizontal' === A.value && k.value ? 'bottom-start' : 'right-start')),
      C = u(() =>
        ('horizontal' === A.value && k.value) || ('vertical' === A.value && !v.props.collapse)
      ...
      I = u(() =>
        v.props.collapse ? `${d.namespace.value}-zoom-in-left` : `${d.namespace.value}-zoom-in-top`
      ),
      $ = u(() =>
      ...
      R = u(() =>
        'horizontal' !== A.value
          ? { color: z.value }
          : {
              borderBottomColor: P.value ? (v.props.activeTextColor ? B.value : '') : 'transparent',
      ...
      X = () => {
        ;('hover' === v.props.menuTrigger && 'horizontal' === v.props.mode) ||
          ...
          e.disabled ||
          v.handleSubMenuClick({ index: e.index, indexPath: i.value, active: P.value })
      },
      ee = (t, l = e.showTimeout) => {
        ...
        'focus' !== t.type &&
          (('click' === v.props.menuTrigger && 'horizontal' === v.props.mode) ||
            ...
            M.value &&
              (null == (a = c.value.vnode.el) || a.dispatchEvent(new MouseEvent('mouseenter')))))
      },
      te = (t = !1) => {
        var l, a
        ;('click' === v.props.menuTrigger && 'horizontal' === v.props.mode) ||
          ...
          ({ stop: g } = Y(() => !x.value && v.closeMenu(e.index, i.value), e.hideTimeout)),
          M.value &&
            t &&
            ...
            G(
              b,
              {
                ...
                style: {
                  transform: j.value
                    ? (e.expandCloseIcon && e.expandOpenIcon) ||
                      (e.collapseCloseIcon && e.collapseOpenIcon && v.props.collapse)
                      ? 'none'
                      : 'rotateZ(180deg)'
                    : 'none'
                }
              },
              { default: () => (Z(C.value) ? G(r.appContext.components[C.value]) : G(C.value)) }
            )
          ],
          o = v.isMenuPopup
            ? G(
                  ...
                  content: () => {
                    ...
                    return G(
                      ...
                      [
                        G(
                          'ul',
                          { class: [d.b(), d.m('popup'), d.m(`popup-${_.value}`)], style: O.value },
                ...
                G(
                  ...
                  {},
                  {
                    default: () => {
                      var e
                      return K(
                        G('ul', { role: 'menu', class: [d.b(), d.m('inline')], style: O.value }, [
...
var Rt = r({
  ...
  emits: {
    close: (e, t) => Z(e) && Ot(t),
    open: (e, t) => Z(e) && Ot(t),
    select: (e, t, l, a) => Z(e) && Ot(t) && ae(l) && (void 0 === a || a instanceof Promise)
  },
  setup(e, { emit: l, slots: o, expose: n }) {
    const r = V(),
      ...
      f = t({}),
      g = t({}),
      x = u(() => 'horizontal' === e.mode || ('vertical' === e.mode && e.collapse)),
      y = (t, a) => {
        m.value.includes(t) ||
        ...
        ;((v.value = -1),
          oe(() => {
            v.value = (() => {
              ...
              if (!c.value) return -1
              const l = Array.from(
                  null != (t = null == (e = c.value) ? void 0 : e.childNodes) ? t : []
                ).filter(
                  (e) => '#comment' !== e.nodeName && ('#text' !== e.nodeName || e.nodeValue)
                ),
    ...
    ;(D(
      ...
      ee(() => {
        'horizontal' === e.mode && e.ellipsis ? ($ = te(c, I).stop) : null == $ || $()
      }))
    {
      const l = (e) => {
          g.value[e.index] = e
        ...
        ;(null == o ? void 0 : o.length) &&
          ...
          n.push(
            G(
              ...
              {
                title: () => G(b, { class: p.e('icon-more') }, { default: () => G(le) }),
                default: () => o
              }
            )
          ))
    ...
    setup(e, { emit: t }) {
      ...
      return (
        ...
        }),
        {
          ...
          handleClick: () => {
            e.disabled ||
              (n.handleMenuItemClick({ index: e.index, indexPath: d.value, route: e.route }),
              t('click', m))
          }
        }
      )
          ...
          v(
            ...
            [
              'ElMenu' === e.parentMenu.type.name && e.rootMenu.props.collapse && e.$slots.title
                ...
                : (i(), v(Q, { key: 1 }, [g(e.$slots, 'default'), g(e.$slots, 'title')], 64))
            ],
            2
          )
        )
...
const qt = k(Rt, { MenuItem: Nt, MenuItemGroup: Ft, SubMenu: At }),
  Dt = B(Nt)
B(Ft)
const Wt = B(At),
  Gt = r({
  ...
  { renderMenuTitle: Kt } = {
    renderMenuTitle: (e) => {
      ...
      return a
        ? x(Q, null, [x(ce, { icon: e.icon }, null), x('span', { class: 'v-menu__title' }, [t(l)])])
      ...
      a.map((a) => {
        ...
        if (!n.hidden) {
          const { oneShowingChild: r, onlyOneChild: s } = ((e = [], l) => {
              const a = t(),
                o = e.filter((e) => !(e.meta ?? {}).hidden && ((a.value = e), !0))
              return 1 === o.length
          ...
          if (
            !r ||
            ((null == s ? void 0 : s.children) && !(null == s ? void 0 : s.noShowingChildren)) ||
            ...
            return x(
              Wt,
              { index: u, popperClass: 'vertical' === e ? `${o}--vertical` : `${o}--horizontal` },
    ...
    r({
      ...
      setup(e) {
        const t = ve(),
          ...
          n = he(),
          r = u(() =>
            ['classic', 'topLeft', 'cutMenu'].includes(p(l)) ? 'vertical' : 'horizontal'
          ),
          s = u(() => ('cutMenu' === p(l) ? n.getMenuTabRouters : n.getRouters)),
          i = u(() => t.getCollapse),
            ...
            if ('top' === p(l)) return h()
            {
              ...
              return x(
                ...
                'function' == typeof (e = t = h()) ||
                  ('[object Object]' === Object.prototype.toString.call(e) && !ge(e))
                  ? t
                  : { default: () => [t] }
              )
            }
                ...
                (e = p(d).find((e) => {
                  ...
                  return (
                    ((null == (l = e.meta) ? void 0 : l.alwaysShow) ||
                      ((null == (a = null == e ? void 0 : e.children) ? void 0 : a.length) &&
                        (null == (o = null == e ? void 0 : e.children) ? void 0 : o.length) > 1)) &&
                    e.path === t
                  )
                }))
                  ? void 0
                  : e.children
            ;((f.value = t),
              a && i.setMenuTabRouters(be(a).map((e) => ((e.path = pe(p(f), e.path)), e))))
          }
        }),
          D(
            () => c.value,
            ...
            x(
              'div',
              {
                ...
                class: [
                  ...
                  { 'w-[var(--tab-menu-max-width)]': !p(r), 'w-[var(--tab-menu-min-width)]': p(r) }
                ]
              },
              [
                x(
                          ...
                          p(d).map((t) => {
                            ...
                            return x(
                              'div',
                              {
                                ...
                                onClick: () => {
                                  ;((t) => {
                                    if (de(t.path)) return void window.open(t.path)
                                    const l = t.children ? t.path : t.path.split('/')[0],
                                      a = p(f)
                                    ;((f.value = t.children ? t.path : t.path.split('/')[0]),
                                      t.children
                                        ? ((l !== a && p(h)) || (h.value = !p(h)),
                                          p(h) &&
                                            i.setMenuTabRouters(
                                              be(t.children).map(
                                                (e) => ((e.path = pe(p(f), e.path)), e)
                                              )
                                            ))
                                        : (e(t.path), i.setMenuTabRouters([]), (h.value = !1)))
                                  })(c)
                                }
                              },
                              [
                                x('div', null, [
                                  x(
                                    ...
                                    {
                                      icon:
                                        null == (s = null == c ? void 0 : c.meta) ? void 0 : s.icon
                                    },
                                    null
                                  )
                                ]),
                                p(m)
                                  ? x('p', { class: 'break-words mt-5px px-2px' }, [
                                      o((null == (u = c.meta) ? void 0 : u.title) || '')
                                    ])
                                  : void 0
                              ]
                            )
                ...
                x(
                  ...
                  [x(ce, { icon: p(r) ? 'ep:d-arrow-right' : 'ep:d-arrow-left' }, null)]
                ),
                x(
                  Xt,
                  {
    ...
    return (
      e.forEach((e) => {
        const a = e.meta ?? {},
          o = pe(t, e.path)
        if (
          ((null == a ? void 0 : a.affix) && l.push({ ...e, path: o, fullPath: o }), e.children)
        ) {
...
function ul({ el: e, position: l = 'scrollLeft', to: a, duration: o = 500, callback: n }) {
  const r = t(!1),
    s = e[l],
    u = a - s,
    i = 20
  ...
  function d() {
    ...
    const t =
      ...
      (v = s),
      (m = u),
      (a /= o / 2) < 1 ? (m / 2) * a * a + v : (-m / 2) * (--a * (a - 2) - 1) + v)
    var a, v, m
    ;(((e, t, l) => {
      e[t] = l
    })(e, l, t),
...
const il = ['id'],
        ...
        const { getPrefixCls: l } = ue(),
          ...
          { currentRoute: r, push: s } = me(),
          {
            ...
            return {
              ...
              closeCurrent: (t, a) => {
                var o
                ;(null == (o = null == t ? void 0 : t.meta) ? void 0 : o.affix) ||
                  (e.delView(t || p(l)), null == a || a())
              },
              refreshPage: async (a, o) => {
                e.delCachedView()
                const { path: n, query: r } = a || p(l)
                ;(await oe(), t({ path: '/redirect' + n, query: r }), null == o || o())
              },
              setTitle: (t, l) => {
                e.setTitle(t, l)
              }
          ...
          W = (e) => {
            var t
            const l = null == (t = p(J)) ? void 0 : t.wrapRef
            let a = null,
              n = null
            const r = p(q)
            if (
              ...
              const { start: e } = ul({ el: l, position: 'scrollLeft', to: 0, duration: 500 })
              e()
              ...
              if (u > p(Y) + l.offsetWidth) {
                ...
                const { start: e } = ul({ el: l, position: 'scrollLeft', to: i, duration: 500 })
                e()
              }
            }
          },
          ...
          ee = (e) => {
            var t
            const l = null == (t = p(J)) ? void 0 : t.wrapRef,
              { start: a } = ul({ el: l, position: 'scrollLeft', to: p(Y) + e, duration: 500 })
            a()
          }
        return (
          a(() => {
                ...
                (async () => {
                  ...
                  for (const e of p(T))
                    if (e.fullPath === p(r).path) {
                      ;(W(e), e.fullPath !== p(r).fullPath && I.updateVisitedView(p(r)))
                      break
                    }
                })())
            }
          ...
          (e, t) => {
            ...
            return (
              ...
              v(
                ...
                {
                  id: p(o),
                  class: h([p(o), 'flex w-full relative bg-[#fff] dark:bg-[var(--el-bg-color)]'])
                },
                [
                  j(
                    'span',
                    ...
                    [
                      x(
                        g,
                        {
                          ...
                          'hover-color': z.value ? '#fff' : 'var(--el-color-black)'
                        },
                        null,
                        8,
                        ['hover-color']
                  ...
                  j('div', cl, [
                    x(
                      p(fe),
                      { ref_key: 'scrollbarRef', ref: J, class: 'h-full', onScroll: X },
                      {
                        default: d(() => [
                          j('div', dl, [
                            (i(!0),
                                      ...
                                      schema: [
                                        {
                                          ...
                                          disabled:
                                            (null == (t = V.value) ? void 0 : t.fullPath) !==
                                            e.fullPath,
                                          command: () => {
                                            U(e)
                                          }
                                        ...
                                        },
                                        {
                                          ...
                                          disabled:
                                            ...
                                            (e.fullPath === T.value[T.value.length - 1].fullPath ||
                                              (null == (v = V.value) ? void 0 : v.fullPath) !==
                                                e.fullPath),
                                          command: () => {
                                            F()
                                          }
                                              ...
                                              default: d(({ navigate: t }) => {
                                                ...
                                                return [
                                                  j(
                                                    ...
                                                    [
                                                      (null == e ? void 0 : e.matched) &&
                                                      (null == e ? void 0 : e.matched[1]) &&
                                                      (null ==
                                                      (a =
                                                        null ==
                                                        (l = null == e ? void 0 : e.matched[1])
                                                          ? void 0
                                                          : l.meta)
                                                        ? void 0
                                                        : a.icon) &&
                    ...
                    p(sl),
                    {
                      ...
                      schema: [
                        ...
                        },
                        {
                          ...
                          disabled:
                            !!(null == (r = T.value) ? void 0 : r.length) &&
                            (null == (s = V.value) ? void 0 : s.fullPath) === T.value[0].fullPath,
                          command: () => {
                            N()
                          }
                        },
                        ...
                        v(
                          'div',
                          {
                            ...
                            class: h([
                              ...
                              {
                                'text-[var(--logo-title-text-color)]': 'classic' === c.value,
                  ...
                  class: h([
                    'p-[var(--app-content-padding)] w-[calc(100%-var(--app-content-padding)-var(--app-content-padding))] bg-[var(--app-content-bg-color-new)] dark:bg-[var(--el-bg-color)]',
                    {
                      '!min-h-[calc(100%-var(--app-footer-height))]':
                        (a.value &&
                          ('classic' === l.value || 'topLeft' === l.value || 'top' === l.value) &&
                          o.value) ||
                ...
                [
                  x(n, null, {
                    default: d(({ Component: e, route: t }) => [
                      (i(),
                      c(Me, { include: r.value }, [(i(), c(P(e), { key: t.fullPath }))], 1032, [
                        'include'
                      ]))
                    ]),
                    _: 1
          ...
          c(
            ...
            { class: h(p(l)), trigger: 'click', onCommand: r },
            {
                      ...
                      we(
                        ...
                        (e) => (
                          ...
                          c(
                            p(lt),
                            { key: e, command: e },
                            { default: d(() => [se(L(p(a)(`size.${e}`)), 1)]), _: 2 },
                            1032,
                            ['command']
                          )
                        )
              ...
              default: d(() => [
                x(
                  s,
                  { size: 18, icon: 'mdi:format-size', color: e.color, class: 'cursor-pointer' },
                  null,
                  8,
                  ['color']
                )
  ...
  bl = Te('lock', {
    ...
    actions: {
      ...
      unLock(e) {
        var t
        return (
          (null == (t = this.lockInfo) ? void 0 : t.password) === e && (this.resetLockInfo(), !0)
        )
      }
    },
    persist: { enabled: !0, strategies: [{ key: 'lock', storage: localStorage }] }
  }),
  yl = ((e) => (Ve('data-v-44fc72b4'), (e = e()), Se(), e))(() =>
    j(
      ...
      [
        ...
        j('span', { class: 'text-14px my-10px text-[var(--top-header-text-color)]' }, 'Archer')
      ],
      -1
    )
  ),
        ...
        return (e, t) => (
          ...
          c(
            ...
            },
            {
              ...
              default: d(() => [
                yl,
                x(p(Je), { 'is-col': !1, schema: b, rules: g, onRegister: p(y) }, null, 8, [
                  'schema',
                  'rules',
                  'onRegister'
                ])
  ...
  kl = ((e) => (Ve('data-v-446e738e'), (e = e()), Se(), e))(() =>
    j(
      ...
      [
        j('img', { src: it, alt: '', class: 'w-70px h-70px rounded-[50%]' }),
        j('span', { class: 'text-14px my-10px text-[var(--logo-title-text-color)]' }, 'Archer')
      ],
      -1
    )
  ),
            ...
            [
              K(
                j(
                  ...
                  [x(p(ce), { icon: 'ep:lock' }), j('span', null, L(p(M)('lock.unlock')), 1)],
                  2
                ),
                [[J, r.value]]
              ),
              j('div', Cl, [
                j(
                  'div',
                  { class: h([`${p(u)}__hour`, 'relative mr-5 md:mr-20 w-2/5 h-2/5 md:h-4/5']) },
                  [
                    j('span', null, L(p(m)), 1),
                    K(
                      j(
                              ...
                              n.value
                                ? (i(),
                                  v(
                                    ...
                                    {
                                      key: 0,
                                      class: h(`text-14px ${p(u)}-entry__err-msg enter-x`)
                                    },
                                    L(p(M)('lock.message')),
                                    3
                                  ))
                              ...
                              j(
                                ...
                                [
                                  x(
                                    ...
                                    { default: d(() => [se(L(p(M)('common.back')), 1)]), _: 1 },
                                    8,
                                    ['disabled']
                                  ),
                                  x(
                                    ...
                                    {
                                      default: d(() => [se(L(p(M)('lock.backToLogin')), 1)]),
                                      _: 1
                                    },
                                    8,
                                    ['disabled']
                                  ...
                                  x(
                                    ...
                                    {
                                      default: d(() => [se(L(p(M)('lock.entrySystem')), 1)]),
                                      _: 1
                                    },
                                    8,
                                    ['disabled']
              ...
              j('div', Ml, [
                K(
                  j(
                    'div',
                    Il,
                    [se(L(p(m)) + ':' + L(p(g)) + ' ', 1), j('span', Tl, L(p(b)), 1)],
                    512
                  ),
                  [[J, !r.value]]
                ),
                j('div', $l, L(p(y)) + '/' + L(p(f)) + '/' + L(p(C)) + ' ' + L(p(k)), 1)
              ])
            ],
            2
          )
  ...
  jl = ['src'],
  Pl = { class: '<lg:hidden text-14px pl-[5px] text-[var(--top-header-text-color)]' },
  Ll = r({
    __name: 'UserInfo',
    setup(e) {
      const l = bl(),
            ...
            [
                    ...
                    x(p(tt), null, {
                      default: d(() => [
                        ...
                        x(
                          ...
                          {
                            default: d(() => [
                              j('div', { onClick: b }, L(p(m)('lock.lockScreen')), 1)
                            ]),
                            _: 1
                          }
                        ),
                        x(p(lt), null, {
                          default: d(() => [
                            j('div', { onClick: f }, L(p(m)('common.loginOut')), 1)
                          ]),
                          _: 1
                        })
                      ]),
              ...
              c(ze, { to: 'body' }, [
                x(
                  ...
                  { default: d(() => [a.value ? (i(), c(Vl, { key: 0 })) : w('', !0)]), _: 1 }
                )
              ]))
            ],
            64
      ...
      return (t, a) => (
        ...
        v(
          ...
          [
            x(
              p(ce),
              { size: 18, icon: p(o) ? 'zmdi:fullscreen-exit' : 'zmdi:fullscreen', color: e.color },
              null,
              8,
              ['icon', 'color']
            )
...
const { getPrefixCls: Al } = ue(),
      ...
      setup() {
        ...
        return (
          ...
          () => {
            ...
            return x(
              $t,
              { separator: '/', class: `${El} flex items-center h-full ml-[10px]` },
              {
                default: () => {
                  return [
                    x(
                              ...
                              default: () => {
                                ...
                                return [
                                  (null == a ? void 0 : a.icon) && Rl.value
                                    ? x(Q, null, [
                                        x(ce, { icon: a.icon, class: 'mr-[5px]' }, null),
                                        se(' '),
                                        l(
                      ...
                      'function' == typeof t ||
                      ('[object Object]' === Object.prototype.toString.call(t) && !ge(t))
                        ? e
                        : { default: () => [e] })
                    )
                  ]
  ...
  Ul = (e) => /^#([0-9a-fA-F]{3}|[0-9a-fA-f]{6})$/.test(e),
  Nl = (e, t) => {
    let l = e.toLowerCase()
    if (Ul(e)) {
      if (4 === l.length) {
  ...
  Gl = xe(
    r({
      ...
      props: { schema: { type: Array, default: () => [] }, modelValue: Ie.string.def('') },
                    ...
                    we(
                      ...
                      (e, t) => (
                        ...
                        v(
                          ...
                          [
                            r.value === e
                              ? (i(), c(a, { key: 0, color: '#fff', icon: 'ep:check', size: 16 }))
                              : w('', !0)
                          ],
                          14,
                          Wl
  ...
  Ql = { class: 'text-14px' },
  Yl = { class: 'flex justify-between items-center' },
  Xl = { class: 'text-14px' },
        ...
        (e, t) => (
          ...
          v(
            ...
            [
              ...
              j('div', Jl, [
                j('span', Ql, L(p(n)('setting.breadcrumbIcon')), 1),
                x(
                  p(ht),
                  {
                    modelValue: c.value,
              ...
              j('div', oa, [
                ...
                x(
                  ...
                  {
                    modelValue: _.value,
                    'onUpdate:modelValue': t[5] || (t[5] = (e) => (_.value = e)),
                    onChange: C
                  },
                  null,
                  8,
              ...
              j('div', pa, [
                ...
                x(
                  ...
                  {
                    modelValue: S.value,
                    'onUpdate:modelValue': t[9] || (t[9] = (e) => (S.value = e)),
                    onChange: P
                  },
                  null,
                  8,
              ...
              j('div', xa, [
                ...
                x(
                  ...
                  {
                    modelValue: O.value,
                    'onUpdate:modelValue': t[12] || (t[12] = (e) => (O.value = e)),
                    onChange: R
                  },
                  null,
                  8,
  ...
  wa = [
    ((e) => (Ve('data-v-8c3c6718'), (e = e()), Se(), e))(() =>
      j('div', { class: 'absolute h-full w-[33%] top-0 left-[10%] bg-gray-200' }, null, -1)
    )
  ],
  _a = xe(
    r({
    ...
    r({
      ...
      setup(e) {
          ...
          _ = (e) => {
            const t = Re('--el-color-primary', document.documentElement),
              ...
              a = {
                ...
                leftMenuBgActiveColor: l ? 'var(--el-color-primary)' : Nl(p(t), 0.1),
                leftMenuCollapseBgActiveColor: l ? 'var(--el-color-primary)' : Nl(p(t), 0.1),
        ...
        D(
          () => s.value,
          (e) => {
            'top' !== e || n.getIsDark ? _(p(y)) : ((g.value = '#fff'), b('#fff'))
          }
        )
        const C = async () => {
            const {
            ...
            l
              ? (await e(), p(t) && Ne.success(r('setting.copySuccess')))
              : Ne.error(r('setting.copyFailed'))
          },
          k = () => {
            ...
            v(
              ...
              [
                ...
                x(
                  ...
                  {
                    modelValue: c.value,
                    'onUpdate:modelValue': l[4] || (l[4] = (e) => (c.value = e)),
                    direction: 'rtl',
                    size: '350px',
                    'z-index': 4e3
                  },
                  {
                    header: d(() => [j('span', Ca, L(p(r)('setting.projectSetting')), 1)]),
                    default: d(() => [
                      j('div', ka, [
                        x(p(mt), null, {
                        ...
                        x(_a),
                        x(p(mt), null, {
                          default: d(() => [se(L(p(r)('setting.systemTheme')), 1)]),
                          _: 1
                        }),
                        x(
                          Gl,
                          {
                            modelValue: m.value,
                            'onUpdate:modelValue': l[1] || (l[1] = (e) => (m.value = e)),
                            schema: [
                              '#409eff',
                              '#009688',
                              '#536dfe',
                        ...
                        x(p(mt), null, {
                          default: d(() => [se(L(p(r)('setting.headerTheme')), 1)]),
                          _: 1
                        }),
                        x(
                          Gl,
                          {
                            modelValue: g.value,
                            'onUpdate:modelValue': l[2] || (l[2] = (e) => (g.value = e)),
                            schema: [
                              '#fff',
                              '#151515',
                              '#5172dc',
                        ...
                        'top' !== s.value
                          ? (i(),
                            v(
                              ...
                              [
                                x(p(mt), null, {
                                  default: d(() => [se(L(p(r)('setting.menuTheme')), 1)]),
                                  _: 1
                                }),
                                x(
                                  Gl,
                                  {
                                    modelValue: y.value,
                                    'onUpdate:modelValue': l[3] || (l[3] = (e) => (y.value = e)),
                                    schema: [
                                      '#fff',
                                      '#001529',
                                      '#212121',
                      ...
                      x(p(mt), null, {
                        default: d(() => [se(L(p(r)('setting.interfaceDisplay')), 1)]),
                        _: 1
                      }),
                      x(ya),
                      x(p(mt)),
                      j('div', null, [
                        x(
                          ...
                          { default: d(() => [se(L(p(r)('setting.copy')), 1)]), _: 1 }
                        )
                      ]),
                      j('div', Ma, [
                        x(
                          ...
                          { default: d(() => [se(L(p(r)('setting.clearAndReset')), 1)]), _: 1 }
                        )
                      ])
                    ]),
                    _: 1
            ...
            'top' !== za.value
              ? x('div', { class: 'h-full flex items-center' }, [
                  Pa.value && 'cutMenu' !== za.value
                    ? x(gl, { class: 'custom-hover', color: 'var(--top-header-text-color)' }, null)
                    : void 0,
                  ja.value ? x(Hl, { class: '<md:hidden' }, null) : void 0
                ])
              : void 0,
            x('div', { class: 'h-full flex items-center' }, [
              x(Ia, { class: 'custom-hover', color: 'var(--top-header-text-color)' }, null),
              La.value
                ? x(Bl, { class: 'custom-hover', color: 'var(--top-header-text-color)' }, null)
                : void 0,
              Ba.value
                ? x(xl, { class: 'custom-hover', color: 'var(--top-header-text-color)' }, null)
                : void 0,
              Aa.value
                ? x(rt, { class: 'custom-hover', color: 'var(--top-header-text-color)' }, null)
                : void 0,
              x(Ll, null, null)
            ])
          ]
        ...
        x(
          ...
          [
            qa.value
              ...
              : void 0,
            x(Xt, { class: [{ '!h-[calc(100%-var(--logo-height))]': qa.value }] }, null)
          ]
        ),
        x(
          'div',
                        ...
                        x(
                          Ea,
                          {
                            class: [
                              ...
                              { 'layout-border__bottom': !Na.value }
                            ]
                          },
                          null
                        ),
                        Na.value
                          ? x(vl, { class: 'layout-border__bottom layout-border__top' }, null)
                          : void 0
                      ]
                    ),
                    x(fl, null, null)
          ...
          'div',
          {
            class: [
              ...
              'w-full',
              {
                ...
                'h-[calc(100%-var(--tags-view-height)-var(--app-footer-height))]': Da.value
              }
            ]
          },
          [
  ...
  ao = xe(
    r({
      name: 'Layout',
      setup: () => () =>
        x('section', { class: [Ja, `${Ja}__${eo.value}`, 'w-[100%] h-[100%] relative'] }, [
          Ya.value && !Xa.value
            ? x(
                'div',
                {
