...
import { E as ae } from './focus-trap-949626e0.js'
const ie =
    ...
    return {
      useModelToggle: ({
        ...
        const g = n(),
          ...
          w = r(() => null === b[e]),
          x = (e) => {
            !0 !== u.value && ((u.value = !0), f && (f.value = e), o(v) && v(e))
          },
          O = (e) => {
            !1 !== u.value && ((u.value = !1), f && (f.value = e), o(m) && m(e))
          },
          R = (e) => {
          ...
          k = (e) => {
            l(e) && (b.disabled && e ? y.value && h(t, !1) : u.value !== e && (e ? x() : O()))
          }
        return (
          a(() => b[e], k),
          c &&
...
function qe(e) {
  return 'html' === Ee(e) ? e : e.assignedSlot || e.parentNode || (je(e) ? e.host : null) || We(e)
}
function Ne(e) {
  return Ce(e) && 'fixed' !== He(e).position ? e.offsetParent : null
}
function Ue(e) {
  for (var t = Te(e), n = Ne(e); n && $e(n) && 'static' === He(n).position; ) n = Ne(n)
  return n && ('html' === Ee(n) || ('body' === Ee(n) && 'static' === He(n).position))
    ? t
    : n ||
        (function (e) {
          ...
          if (-1 !== navigator.userAgent.indexOf('Trident') && Ce(e) && 'fixed' === He(e).position)
            return null
          var n = qe(e)
          for (je(n) && (n = n.host); Ce(n) && ['html', 'body'].indexOf(Ee(n)) < 0; ) {
            var r = He(n)
            if (
              'none' !== r.transform ||
              'none' !== r.perspective ||
...
function Qe(e) {
  ...
  if (p) {
    ...
    if (
      ...
      ((w = ce),
        (m -= (f && O === x && x.visualViewport ? x.visualViewport.height : O[R]) - r.height),
        (m *= l ? 1 : -1))
    if (o === ve || ((o === fe || o === ce) && a === be))
      ((y = de),
        (d -= (f && O === x && x.visualViewport ? x.visualViewport.width : O[A]) - r.width),
        (d *= l ? 1 : -1))
  }
  var k,
  ...
  return (
    ...
    l
      ...
      : Object.assign(
          {},
          E,
          (((t = {})[w] = b ? m + 'px' : ''), (t[y] = h ? d + 'px' : ''), (t.transform = ''), t)
        )
  )
}
var Ge = {
      ...
      : ft(
          (function (e) {
            var t,
              ...
              a = Pe(n.scrollWidth, n.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0),
              i = Pe(
                n.scrollHeight,
                n.clientHeight,
                o ? o.scrollHeight : 0,
              ...
              l = -r.scrollTop
            return (
              'rtl' === He(o || n).direction && (s += Pe(n.clientWidth, o ? o.clientWidth : 0) - a),
...
function dt(e, t, n) {
  var r =
      'clippingParents' === t
        ? (function (e) {
            var t = ut(qe(e)),
              n = ['absolute', 'fixed'].indexOf(He(e).position) >= 0 && Ce(e) ? Ue(e) : e
            return Se(n)
              ? t.filter(function (e) {
    ...
    if (!t.modifiersData[r]._skip) {
      for (
              ...
              Me(n) === me
                ? (function (e, t) {
                    ...
                    var d = c.reduce(function (t, n) {
                      return (
                        (t[n] = mt(e, { placement: n, boundary: o, rootBoundary: a, padding: i })[
                          Me(n)
                        ]),
                        t
                      )
        ...
        var E = y[k],
          ...
          C = [fe, ce].indexOf(T) >= 0,
          j = C ? 'width' : 'height',
          B = mt(t, { placement: E, boundary: u, rootBoundary: f, altBoundary: c, padding: p }),
          M = C ? (S ? de : ve) : S ? ce : fe
        w[j] > x[j] && (M = rt(M))
        var P = rt(M),
          F = []
...
var wt = {
  ...
  fn: function (e) {
    var t = e.state,
      ...
      p = s.y
    ;(null != t.modifiersData.popperOffsets &&
      ((t.modifiersData.popperOffsets.x += l), (t.modifiersData.popperOffsets.y += p)),
      (t.modifiersData[r] = i))
  }
}
var xt = {
...
var Ot = {
  ...
  fn: function (e) {
    var t = e.state,
      ...
      R = t.rects.reference,
      A = t.rects.popper,
      k = 'function' == typeof m ? m(Object.assign({}, t.rects, { placement: t.placement })) : m,
      E =
        'number' == typeof k
...
function Rt(e, t, n) {
  ...
  return (
    (r || (!r && !n)) &&
      ...
      Ce(t) ? (((l = De(t, !0)).x += t.clientLeft), (l.y += t.clientTop)) : a && (l.x = st(a))),
    {
      ...
      l = {
        ...
        setOptions: function (n) {
          ...
          ;(p(),
            ...
            (o.scrollParents = {
              reference: Se(e) ? ut(e) : e.contextElement ? ut(e.contextElement) : [],
              popper: ut(t)
            }))
          var u = (function (e) {
            var t = At(e)
              ...
              for (var r = 0; r < o.orderedModifiers.length; r++)
                if (!0 !== o.reset) {
                  var a = o.orderedModifiers[r],
                    ...
                    f = a.name
                  'function' == typeof i &&
                    (o = i({ state: o, options: u, name: f, instance: l }) || o)
                } else ((o.reset = !1), (r = -1))
            }
          }
        },
...
const jt = (e, t, n = {}) => {
  const o = {
    ...
    i = r(() => {
      const { onFirstUpdate: e, placement: t, strategy: r, modifiers: a } = p(n)
      return {
        onFirstUpdate: e,
        placement: t || 'bottom',
        strategy: r || 'absolute',
                  ...
                  H(e) &&
                    ([
                      ...
                      a &&
                        ...
                        null == (o = null == t ? void 0 : t.removeEventListener) ||
                    ...
                    (m = a(
                      ...
                      (t) => {
                        ;[
                          ...
                          oe(t[r]) ? e.removeAttribute(n) : e.setAttribute(n, t[r])
                        })
                      },
                      { immediate: !0 }
                    ))),
...
const rn = (e) => {
    const { popperInstanceRef: t, contentRef: n, triggerRef: o, role: l } = k(It, void 0),
      u = f(),
      c = f(),
  ...
  x({
    ...
    setup(e, { expose: t, emit: n }) {
      const o = e,
        {
          ...
          return {
            ...
            onFocusoutPrevented: (t) => {
              e.trapping ||
                ('pointer' === t.detail.focusReason && t.preventDefault(), (n.value = !1))
            },
            onReleaseRequested: () => {
              ;((n.value = !1), t('close'))
            }
        ...
        } = rn(o),
        {
          ...
          const { nextZIndex: a } = U(),
            ...
            s = r(() => p(t).popper),
            l = f(e.zIndex || a()),
            u = r(() => [i.b(), i.is('pure', e.pure), i.is(e.effect), e.popperClass]),
      ...
      ;(w(Ht, { arrowStyle: M, arrowRef: b, arrowOffset: $ }),
        I && (I.addInputId || I.removeInputId) && w(z, { ...I, addInputId: j, removeInputId: j }))
      const V = (e = !0) => {
          ;(C(), e && D())
        },
        K = () => {
          ;(V(!1), o.visible && o.focusOnShow ? (l.value = !0) : !1 === o.visible && (l.value = !1))
        }
      return (
        i(() => {
          ;(a(
                ...
                (N = a(
                  ...
                  (e) => {
                    ;['role', 'aria-label', 'aria-modal', 'id'].forEach((t, r) => {
                      oe(e[r]) ? n.removeAttribute(t) : n.setAttribute(t, e[r])
                    })
                  },
                  { immediate: !0 }
                )),
        ...
        t({ popperContentRef: y, popperInstanceRef: R, updatePopper: V, contentStyle: L }),
        (e, t) => (
          E(),
          T(
            'div',
...
const sn = V(qt),
  ...
  { useModelToggleProps: fn, useModelToggleEmits: cn, useModelToggle: dn } = ue('visible'),
  vn = b({ ...$t, ...fn, ...pn, ...un, ...Nt, showArrow: { type: Boolean, default: !0 } }),
...
var bn = R(
  x({
    ...
    setup(e, { expose: t }) {
      const n = e,
        r = A('tooltip'),
        { controlled: o, id: a, open: i, onOpen: s, onClose: l, onToggle: u } = k(ln, void 0),
        c = f(null),
        d = () => {
                  ...
                  default: W(() => [
                    p(S)
                      ? B(
                          ...
                          $(
                            p(an),
                            q({ key: 0, id: p(d), ref_key: 'contentRef', ref: s }, e.$attrs, {
                            ...
                            {
                              default: W(() => [
                                l.value ? N('v-if', !0) : O(e.$slots, 'default', { key: 0 })
                              ]),
                              _: 3
                            },
                            16,
    ...
    x({
      ...
      setup(e, { expose: t, emit: n }) {
        ...
        const i = ee(),
          ...
          d = f(!1),
          v = f(),
          { show: m, hide: g, hasUpdateHandler: h } = dn({ indicator: d, toggleReason: v }),
              ...
              { ref_key: 'popperRef', ref: s, role: e.role },
              {
                default: W(() => [
                  _(
                    ...
                    {
                      default: W(() => [
                        e.$slots.default ? O(e.$slots, 'default', { key: 0 }) : N('v-if', !0)
                      ]),
                      _: 3
                    },
                    8,
                  ...
                  _(
                    ...
                    },
                    {
                      default: W(() => [
                        O(e.$slots, 'content', {}, () => [
                          e.rawContent
                            ? (E(), T('span', { key: 0, innerHTML: e.content }, null, 8, xn))
                            : (E(), T('span', On, re(e.content), 1))
                        ]),
                        e.showArrow
                          ? (E(),
                            $(p(zt), { key: 0, 'arrow-offset': e.arrowOffset }, null, 8, [
                              'arrow-offset'
                            ]))
                          : N('v-if', !0)
                      ]),
...
export { An as E, Vt as O, ln as T, Ae as a, un as b, ie as c, Dt as d, pn as u, se as w, Ct as y }
