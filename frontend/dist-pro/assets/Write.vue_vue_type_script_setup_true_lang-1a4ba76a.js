...
import { u as s } from './dict-451afacd.js'
import { e as a } from './task-7432fb5b.js'
import { e as r, L as l, w as p, o as n, l as m, k as i } from './index-820a519e.js'
const c = r({
  __name: 'Write',
    ...
    const d = r,
      ...
      f = l([
        ...
        },
        {
          ...
          optionApi: async () => {
            const e = s()
            return (await e.getDictObj(['vadmin_system_task_exec_strategy']))
              .vadmin_system_task_exec_strategy
          }
        },
        {
          field: 'expression',
          ...
          ifshow: (e) => 'interval' === e.exec_strategy,
          formItemProps: { rules: [u()] }
        },
        {
          field: 'expression',
      ...
      { setValues: w, getFormData: h, getElFormExpose: Y } = y
    return (
      p(
        () => d.currentRow,
        (e) => {
      ...
      (e, o) => (n(), m(i(t), { onRegister: i(P), schema: f }, null, 8, ['onRegister', 'schema']))
    )
  }
})
export { c as _ }
