  ...
  v = e({
    ...
    setup(e) {
      const v = e,
        ...
        j = async () => {
          h.value = !0
          const e = b.value.filter((e) => !0 !== e.reset_password_status).map((e) => e.id)
        ...
        return (
          ...
          t('div', null, [
            ...
            l(
              ...
              {
                default: n(() => [
                  l(d(_), { prop: 'id', label: '用户编号', width: '100', align: 'center' }),
                  l(d(_), { prop: 'name', label: '姓名', width: '120', align: 'center' }),
                  l(d(_), { prop: 'telephone', label: '手机号', width: '120', align: 'center' }),
                  l(
                    d(_),
                    {
                  ...
                  l(
                    d(_),
                    { prop: 'send_sms_status', label: '发送状态', width: '100', align: 'center' },
                    {
                      default: n((e) => [
                  ...
                  l(d(_), { prop: 'send_sms_msg', label: '描述', align: 'center' }),
                  l(
                    d(_),
                      ...
                      default: n((e) => [
                        l(
                          d(y),
                          {
                            title: '确认移除吗?',
                            onConfirm: (s) => {
                              return ((a = e.$index), void b.value.splice(a, 1))
                              var a
                            }
                          },
                          {
