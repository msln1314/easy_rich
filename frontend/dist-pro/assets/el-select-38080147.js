...
import { E as de, u as ce, a as ve } from './el-popper-797844d6.js'
import { i as he, E as me } from './el-input-5ae17c8f.js'
import { E as fe, t as be } from './index-56bc6266.js'
import { e as ge } from './strings-ed83d626.js'
import { U as ye, C as Ce } from './event-5568c9d8.js'
import { s as Se } from './scroll-ac7d0423.js'
import { i as Oe } from './isEqual-cb9e370d.js'
import { d as xe } from './debounce-5bc596c6.js'
import { C as Te } from './index-eb31d854.js'
import { i as we } from './validator-a9d8fe4c.js'
  ...
  u({
    ...
    setup(e) {
      const r = p('select'),
        ...
        m = d({ index: -1, groupDisabled: !1, visible: !0, hitState: !1, hover: !1 }),
        {
          currentLabel: f,
          itemSelected: b,
          isDisabled: g,
          ...
          const u = l(Ie),
            ...
            c = t(() =>
              u.props.multiple ? g(u.props.modelValue, e.value) : y(e.value, u.props.modelValue)
            ),
            v = t(() => {
              if (u.props.multiple) {
                const e = u.props.modelValue || []
                return !c.value && e.length >= u.props.multipleLimit && u.props.multipleLimit > 0
              }
              return !1
            }),
          ...
          ;(s(
            ...
            s(
              ...
              (l, t) => {
                ...
                if (
                  (Object.is(l, t) || (u.onOptionDestroy(t, b.proxy), u.onOptionCreate(b.proxy)),
                  !e.created && !o)
                ) {
                  if (a && 'object' == typeof l && 'object' == typeof t && l[a] === t[a]) return
                  u.setSelected()
                }
              }
            ),
          ...
          return (
            s(
              ...
              (l) => {
                const { query: t } = i(l),
                  o = new RegExp(ge(t), 'i')
                ;((r.visible = o.test(h.value) || e.created), r.visible || u.filteredOptionsCount--)
              },
              { immediate: !0 }
            ),
            {
              ...
              isDisabled: f,
              hoverItem: () => {
                e.disabled || p.disabled || (u.hoverIndex = u.optionsArray.indexOf(b.proxy))
              }
            }
          )
        })(e, m),
      ...
      return (
        ...
        }),
        {
          ...
          selectOptionClick: function () {
            !0 !== e.disabled && !0 !== m.groupDisabled && y.handleOptionSelect(x)
          },
          states: m
        }
      )
        ...
        return m(
          ...
          g(
            'li',
            {
              ...
              onMouseenter: l[0] || (l[0] = (...l) => e.hoverItem && e.hoverItem(...l)),
              onClick:
                l[1] ||
                (l[1] = x((...l) => e.selectOptionClick && e.selectOptionClick(...l), ['stop']))
            },
            [y(e.$slots, 'default', {}, () => [C('span', null, S(e.currentLabel), 1)])],
            34
          )),
          [[f, e.visible]]
        )
  ...
  u({
    ...
    setup() {
      ...
      return (
        ...
        { ns: o, minWidth: i, popperClass: a, isMultiple: n, isFitInputWidth: s }
      )
    }
  }),
  [
...
const Pe = (l, o, r) => {
  ...
  const { form: I, formItem: j } = V(),
    ...
    Q = t(() => {
      const e = l.multiple
        ...
        : void 0 !== l.modelValue && null !== l.modelValue && '' !== l.modelValue
      return l.clearable && !$.value && o.inputHovering && e
    }),
    N = t(() => (l.remote && l.filterable && !l.remoteShowSuffix ? '' : l.suffixIcon)),
    ...
    J = t(() =>
      l.loading
        ...
        : (!l.remote || '' !== o.query || 0 !== o.options.size) &&
          (l.filterable && o.query && o.options.size > 0 && 0 === o.filteredOptionsCount
    ...
    ee = t(() => {
      const e = Y.value.filter((e) => !e.created).some((e) => e.currentLabel === o.query)
      return l.filterable && l.allowCreate && '' !== o.query && !e
    }),
    le = D(),
    te = t(() => (['small'].includes(le.value) ? 'small' : 'default')),
    oe = t({
      get: () => o.visible && !1 !== J.value,
      set(e) {
        o.visible = e
      }
    })
  ;(s([() => $.value, () => le.value, () => (null == I ? void 0 : I.size)], () => {
    h(() => {
      ae()
    })
  }),
    ...
    s(
      ...
      (e, t) => {
        ;(l.multiple &&
          ...
          !Oe(e, t) && l.validateEvent && (null == j || j.validate('change').catch((e) => K())))
      },
      { flush: 'post', deep: !0 }
    ),
    s(
      ...
      (e) => {
        var t, a, n, s, i
        ;(e
          ? (null == (a = null == (t = f.value) ? void 0 : t.updatePopper) || a.call(t),
            l.filterable &&
              ((o.filteredOptionsCount = o.optionsCount),
              (o.query = l.remote ? '' : o.selectedLabel),
              null == (s = null == (n = m.value) ? void 0 : n.focus) || s.call(n),
              l.multiple
                ? null == (i = v.value) || i.focus()
                : o.selectedLabel &&
                  ((o.currentPlaceholder = `${o.selectedLabel}`), (o.selectedLabel = '')),
              ne(o.query),
              l.multiple || l.remote || ((O.value.query = ''), z(O), z(x))))
          : (l.filterable &&
              (q(l.filterMethod) && l.filterMethod(''), q(l.remoteMethod) && l.remoteMethod('')),
            (o.query = ''),
            ...
            l.multiple ||
              (o.selected &&
                (l.filterable && l.allowCreate && o.createdSelected && o.createdLabel
    ...
    s(
      ...
      () => {
        var e, t, a
        if (!A) return
        ;(null == (t = null == (e = f.value) ? void 0 : e.updatePopper) || t.call(e),
          l.multiple && ae())
        const n = (null == (a = y.value) ? void 0 : a.querySelectorAll('input')) || []
        ;(Array.from(n).includes(document.activeElement) || re(),
          l.defaultFirstOption && (l.filterable || l.remote) && o.filteredOptionsCount && ie())
      },
      { flush: 'post' }
    ),
    s(
  ...
  const ae = () => {
      h(() => {
        ...
        const n = g.value,
          s = ((i = le.value || (null == I ? void 0 : I.size)), e[i || 'default'])
        var i
        ...
        ;(!(null === a.offsetParent) &&
          (a.style.height =
            (0 === o.selected.length
              ? r
              : Math.max(n ? n.clientHeight + (n.clientHeight > r ? 6 : 0) : 0, r)) -
            2 +
            'px'),
          o.visible &&
            !1 !== J.value &&
            (null == (t = null == (l = f.value) ? void 0 : l.updatePopper) || t.call(l)))
      })
    },
    ne = async (e) => {
      o.previousQuery === e ||
        ...
        (null !== o.previousQuery || (!q(l.filterMethod) && !q(l.remoteMethod))
          ? ((o.previousQuery = e),
            h(() => {
              var e, l
              o.visible &&
                (null == (l = null == (e = f.value) ? void 0 : e.updatePopper) || l.call(e))
            }),
            (o.hoverIndex = -1),
            l.multiple &&
              l.filterable &&
              h(() => {
                ...
                ;((o.inputLength = l.collapseTags ? Math.min(50, e) : e), se(), ae())
              }),
            l.remote && q(l.remoteMethod)
              ? ((o.hoverIndex = -1), l.remoteMethod(e))
              : q(l.filterMethod)
                ? (l.filterMethod(e), z(x))
                : ((o.filteredOptionsCount = o.optionsCount), (O.value.query = e), z(O), z(x)),
    ...
    ie = () => {
      const e = Y.value.filter((e) => e.visible && !e.disabled && !e.states.groupDisabled),
    ...
    ue = (e) => {
      ...
      for (let u = o.cachedOptions.size - 1; u >= 0; u--) {
        ...
        if (a ? n(o.value, l.valueKey) === n(e, l.valueKey) : o.value === e) {
          t = { value: e, currentLabel: o.currentLabel, isDisabled: o.isDisabled }
          break
        }
      }
      if (t) return t
        ...
        l.multiple
          ? o.selected.length > 0
            ? (o.hoverIndex = Math.min.apply(
                null,
                o.selected.map((l) => Y.value.findIndex((t) => n(t, e) === n(l, e)))
              ))
            : (o.hoverIndex = -1)
    ...
    ce = xe(() => {
      l.filterable && o.query !== o.selectedLabel && ((o.query = o.selectedLabel), ne(o.query))
    }, X.value),
    ve = xe((e) => {
      ne(e.target.value)
    }, X.value),
    ...
    be = (e) => {
      ...
      ;(r.emit(ye, t), me(t), (o.hoverIndex = -1), (o.visible = !1), r.emit('clear'), Ee())
    },
    ge = (e) => {
      var t
      if (l.multiple) {
        ...
        ;(n > -1
          ? a.splice(n, 1)
          : (l.multipleLimit <= 0 || a.length < l.multipleLimit) && a.push(e.value),
          r.emit(ye, a),
          me(a),
    ...
    Le = (e) => {
      ...
      if (f.value && i) {
        const e =
          ...
          (a =
            null ==
            (o = null == (t = null == (l = f.value) ? void 0 : l.popperRef) ? void 0 : t.contentRef)
              ? void 0
              : o.querySelector)
            ? void 0
    ...
    Ee = () => {
      var e, l
      o.visible ? null == (e = v.value || c.value) || e.focus() : null == (l = c.value) || l.focus()
    },
    Me = () => {
      o.visible = !1
    },
    Pe = (e) => {
      ;(e && !o.mouseEnter) ||
        ...
        (o.menuVisibleOnFocus
          ? (o.menuVisibleOnFocus = !1)
          : (f.value && f.value.isFocusInsideContent()) || (o.visible = !o.visible),
        Ee())
    },
    Ve = (e) => (H(e.value) ? n(e.value, l.valueKey) : e.value),
    ...
    qe = (e) => {
      if (o.visible) {
        if (
          ...
          'next' === e
            ? (o.hoverIndex++, o.hoverIndex === o.options.size && (o.hoverIndex = 0))
            : 'prev' === e &&
              (o.hoverIndex--, o.hoverIndex < 0 && (o.hoverIndex = o.options.size - 1))
          const l = Y.value[o.hoverIndex]
          ;((!0 !== l.disabled && !0 !== l.states.groupDisabled && l.visible) || qe(e),
            h(() => Le(S.value)))
        }
      } else o.visible = !0
    },
    ze = t(() => ({ maxWidth: i(o.inputWidth) - 32 - (U.value ? 22 : 0) + 'px', width: '100%' }))
  return {
    optionList: w,
    optionsArray: Y,
    selectSize: le,
    ...
    resetInputState: (e) => {
      ;(e.code !== F.backspace && Ie(!1), (o.inputLength = 15 * v.value.value.length + 20), ae())
    },
    handleComposition: (e) => {
      const l = e.target.value
      if ('compositionend' === e.type) ((o.isOnComposition = !1), h(() => ne(l)))
      else {
    ...
    onOptionDestroy: (e, l) => {
      o.options.get(e) === l && (o.optionsCount--, o.filteredOptionsCount--, o.options.delete(e))
    },
    handleMenuEnter: () => {
      h(() => Le(o.selected))
    },
    handleFocus: (e) => {
      o.focused ||
        ((l.automaticDropdown || l.filterable) &&
          (l.filterable && !o.visible && (o.menuVisibleOnFocus = !0), (o.visible = !0)),
        (o.focused = !0),
        r.emit('focus', e))
    },
    focus: Ee,
    ...
    handleDeleteTooltipTag: (e, l) => {
      var t, o
      ;(fe(e, l), null == (o = null == (t = b.value) ? void 0 : t.updatePopper) || o.call(t))
    },
    dropMenuVisible: oe,
    queryChange: O,
    groupQueryChange: x,
    ...
    setup(e, l) {
      const o = p('select'),
        ...
        We = t(() => {
          const l = [o.b()],
            t = i(v)
          return (t && l.push(o.m(t)), e.disabled && l.push(o.m('disabled')), l)
        }),
        Be = t(() => [o.e('tags'), o.is('disabled', i(k))]),
        He = t(() => [o.b('tags-wrapper'), { 'has-prefix': i(Ae) && i(Se).length }]),
        Fe = t(() => [o.e('input'), o.is(i(v)), o.is('disabled', i(k))]),
        Re = t(() => [o.e('input'), o.is(i(v)), o.em('input', 'iOS')]),
        je = t(() => [o.is('empty', !e.allowCreate && Boolean(i(Ee)) && 0 === i(xe))]),
        _e = t(() => ({ maxWidth: `${i(Ce) > 123 ? i(Ce) - 123 : i(Ce) - 75}px` })),
        $e = t(() => ({
          marginLeft: `${i(Ae)}px`,
          flexGrow: 1,
          width: i(Oe) / (i(Ce) - 32) + '%',
      ...
      ;(G(
        ...
        w(() => {
          ;((s.cachedPlaceHolder = Ve.value = e.placeholder || (() => n('el.select.placeholder'))),
            e.multiple && Array.isArray(e.modelValue) && e.modelValue.length > 0 && (Ve.value = ''),
            L(pe, f),
            e.remote && e.multiple && M(),
            h(() => {
              const e = ae.value && ae.value.$el
              if (e && ((Ce.value = e.getBoundingClientRect().width), l.slots.prefix)) {
      ...
      const Qe = t(() => {
        var e, l
        return null == (l = null == (e = ie.value) ? void 0 : e.popperRef) ? void 0 : l.contentRef
      })
      return {
        isIOS: U,
        onOptionsRendered: (e) => {
      ...
      return m(
        ...
        g(
          'div',
          {
            ...
            onMouseenter:
              l[22] || (l[22] = (...l) => e.handleMouseEnter && e.handleMouseEnter(...l)),
            onMouseleave:
              l[23] || (l[23] = (...l) => e.handleMouseLeave && e.handleMouseLeave(...l)),
            onClick: l[24] || (l[24] = x((...l) => e.toggleMenu && e.toggleMenu(...l), ['stop']))
          },
          [
            Y(
              i,
                ...
                default: Z(() => [
                  C(
                    'div',
                    {
                      ...
                      onMouseenter: l[20] || (l[20] = (l) => (e.inputHovering = !0)),
                      onMouseleave: l[21] || (l[21] = (l) => (e.inputHovering = !1))
                    },
                    [
                      e.multiple
                        ? (b(),
                          g(
                            'div',
                            {
                              ...
                              onClick: l[15] || (l[15] = (...l) => e.focus && e.focus(...l))
                            },
                            [
                                ...
                                ? m(
                                    ...
                                    g(
                                      'input',
                                      {
                                        ...
                                        onFocus:
                                          l[1] ||
                                          (l[1] = (...l) => e.handleFocus && e.handleFocus(...l)),
                                        onBlur:
                                          l[2] ||
                                          (l[2] = (...l) => e.handleBlur && e.handleBlur(...l)),
                                        onKeyup:
                                          l[3] ||
                                          (l[3] = (...l) =>
                                            e.managePlaceholder && e.managePlaceholder(...l)),
                                        onKeydown: [
                                          l[4] ||
                                            (l[4] = (...l) =>
                                              e.resetInputState && e.resetInputState(...l)),
                                          l[5] ||
                                            (l[5] = ne(
                                              x((l) => e.navigateOptions('next'), ['prevent']),
                                              ['down']
                                            )),
                                          l[6] ||
                                            (l[6] = ne(
                                              x((l) => e.navigateOptions('prev'), ['prevent']),
                                              ['up']
                                            )),
                                          l[7] ||
                                            (l[7] = ne(
                                          ...
                                          l[8] ||
                                            (l[8] = ne(
                                              x(
                                                (...l) => e.selectOption && e.selectOption(...l),
                                                ['stop', 'prevent']
                                              ),
                                              ['enter']
                                            )),
                                          l[9] ||
                                            (l[9] = ne(
                                              (...l) => e.deletePrevTag && e.deletePrevTag(...l),
                                              ['delete']
                                            )),
                                          l[10] || (l[10] = ne((l) => (e.visible = !1), ['tab']))
                                        ],
                                        onCompositionstart:
                                          l[11] ||
                                          (l[11] = (...l) =>
                                            e.handleComposition && e.handleComposition(...l)),
                                        onCompositionupdate:
                                          l[12] ||
                                          (l[12] = (...l) =>
                                            e.handleComposition && e.handleComposition(...l)),
                                        ...
                                        onInput:
                                          l[14] ||
                                          (l[14] = (...l) =>
                                            e.debouncedQueryChange && e.debouncedQueryChange(...l))
                                      },
                                      null,
                                      46,
                                      Ke
                        ...
                        : ae('v-if', !0),
                      ae(' fix: https://github.com/element-plus/element-plus/issues/11415 '),
                      ...
                      Y(
                        u,
                        {
                          ...
                          'onUpdate:modelValue': l[16] || (l[16] = (l) => (e.selectedLabel = l)),
                          type: 'text',
                          placeholder:
                          ...
                          onKeydown: [
                            l[17] ||
                              (l[17] = ne(
                                x((l) => e.navigateOptions('next'), ['stop', 'prevent']),
                                ['down']
                              )),
                            l[18] ||
                              (l[18] = ne(
                                x((l) => e.navigateOptions('prev'), ['stop', 'prevent']),
                                ['up']
                              )),
                            ne(x(e.selectOption, ['stop', 'prevent']), ['enter']),
                            ne(e.handleKeydownEscape, ['esc']),
                            l[19] || (l[19] = ne((l) => (e.visible = !1), ['tab']))
                          ]
                        },
                        ie(
                          {
                              ...
                              e.iconComponent && !e.showClose
                                ? (b(),
                                  ee(
                                    ...
                                    { default: Z(() => [(b(), ee(re(e.iconComponent)))]), _: 1 },
                                    8,
                                    ['class']
                                  ))
                                : ae('v-if', !0),
                              e.showClose && e.clearIcon
                                ? (b(),
                                  ee(
                                    ...
                                    { default: Z(() => [(b(), ee(re(e.clearIcon)))]), _: 1 },
                                    8,
                                    ['class', 'onClick']
                                  ))
                                : ae('v-if', !0)
                          ...
                          [
                            e.$slots.prefix
                              ? {
                                  name: 'prefix',
                                  fn: Z(() => [C('div', ze, [y(e.$slots, 'prefix')])])
                                }
                              : void 0
                          ]
                        ),
                        ...
                        Y(
                          ...
                          },
                          {
                            default: Z(() => [
                              e.showNewOption
                                ? (b(),
                                  ee(p, { key: 0, value: e.query, created: !0 }, null, 8, [
                                    'value'
                                  ]))
                                : ae('v-if', !0),
                              Y(
                                ...
                                { default: Z(() => [y(e.$slots, 'default')]), _: 3 },
                                8,
                                ['onUpdateOptions']
                              )
                            ]),
                            ...
                            [
                              e.$slots.empty
                                ...
                                : (b(),
                                  g(
                                    'p',
                                    { key: 1, class: O(e.nsSelect.be('dropdown', 'empty')) },
                                    S(e.emptyText),
                                    3
                                  ))
                            ],
            ...
            Array.isArray(e.children) &&
              e.children.forEach((e) => {
                ...
                e.type && 'ElOption' === e.type.name && e.component && e.component.proxy
                  ...
                  : (null == (t = e.children) ? void 0 : t.length) && l.push(...v(e))
              }),
            l
          )
        },
        ...
        return m(
          ...
          g(
            ...
            [
              ...
              C('li', null, [C('ul', { class: O(e.ns.b('group')) }, [y(e.$slots, 'default')], 2)])
            ],
            2
          )),
          [[f, e.visible]]
...
const Be = ue(Ae, { Option: Ee, OptionGroup: We }),
  He = pe(Ee),
  Fe = pe(We)
export { Be as E, He as a, Fe as b, Ie as s }
