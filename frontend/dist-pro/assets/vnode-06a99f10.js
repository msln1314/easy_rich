import { aZ as E, ag as T, bg as e, c1 as s } from './index-820a519e.js'
var r = ((E) => (
  (E[(E.TEXT = 1)] = 'TEXT'),
  (E[(E.CLASS = 2)] = 'CLASS'),
  (E[(E.STYLE = 4)] = 'STYLE'),
...
const S = (E) => {
    if (!T(E)) return {}
    const r = E.props || {},
      S = (T(E.type) ? E.type.props : void 0) || {},
      A = {}
    return (
      Object.keys(S).forEach((E) => {
        e(S[E], 'default') && (A[E] = S[E].default)
      }),
      ...
      s.forEach((e) => {
        ...
        E(e)
          ...
          : T(e) && E(e.children)
            ...
            : (r.push(e),
              T(e) &&
                (null == (s = e.component) ? void 0 : s.subTree) &&
                r.push(...A(e.component.subTree)))
      }),
      r
    )
  }
export { r as P, A as f, S as g }
