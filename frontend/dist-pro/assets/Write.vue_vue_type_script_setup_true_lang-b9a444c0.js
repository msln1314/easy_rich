...
import { e as t, ad as l, L as n, w as s, o as p, l as r, k as i } from './index-820a519e.js'
import { b as d } from './dept-b8a01226.js'
const c = t({
  __name: 'Write',
  props: { currentRow: { type: Object, default: () => null }, parentId: l.number.def(void 0) },
  setup(t, { expose: l }) {
    const c = t,
      { required: m } = a(),
      u = n([
        ...
        { field: 'name', label: '部门名称', component: 'Input', colProps: { span: 12 } },
        { field: 'code', label: '部门标识', component: 'Input', colProps: { span: 12 } },
    ...
    return (
      ...
      (e, a) => (
        p(),
        r(i(o), { rules: f, onRegister: i(b), schema: u, labelWidth: 100 }, null, 8, [
          'rules',
          'onRegister',
          'schema'
        ])
