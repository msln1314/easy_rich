...
import { d as K } from './debounce-5bc596c6.js'
function Q(a, s, n) {
  var t = !0,
    l = !0
  if ('function' != typeof a) throw new TypeError('Expected a function')
  return (
    e(n) && ((t = 'leading' in n ? !!n.leading : t), (l = 'trailing' in n ? !!n.trailing : l)),
    ...
    l({
      ...
      setup(e, { expose: a, emit: s }) {
        const n = e,
          ...
          te = f(n.initialIndex),
          le = m(l.CONTAIN),
          oe = f({ scale: 1, deg: 0, offsetX: 0, offsetY: 0, enableTransition: !1 }),
          ie = p(() => {
            const { urlList: e } = n
            return e.length <= 1
          }),
          ...
          de = p(() => [J.e('btn'), J.e('prev'), J.is('disabled', !n.infinite && ce.value)]),
          fe = p(() => [J.e('btn'), J.e('next'), J.is('disabled', !n.infinite && ue.value)]),
          ve = p(() => {
            const { scale: e, deg: a, offsetX: s, offsetY: n, enableTransition: t } = oe.value
            let o = s / e,
              i = n / e
            switch (a % 360) {
              case 90:
            ...
            return (le.value.name === l.CONTAIN.name && (c.maxWidth = c.maxHeight = '100%'), c)
          }),
        ...
        function ke(e) {
          ...
          const { offsetX: a, offsetY: s } = oe.value,
            ...
            t = e.pageY,
            l = Q((e) => {
              oe.value = { ...oe.value, offsetX: a + e.pageX - n, offsetY: s + e.pageY - t }
            }),
        ...
        function we() {
          oe.value = { scale: 1, deg: 0, offsetX: 0, offsetY: 0, enableTransition: !1 }
        }
        function xe() {
          if (ne.value) return
          const e = G(l),
        ...
        function ze(e, a = {}) {
          ...
          const {
            ...
            rotateDeg: t,
            enableTransition: l
          } = { zoomRate: n.zoomRate, rotateDeg: 90, enableTransition: !0, ...a }
          switch (e) {
            case 'zoomOut':
              oe.value.scale > 0.2 &&
                (oe.value.scale = Number.parseFloat((oe.value.scale / s).toFixed(3)))
              break
            case 'zoomIn':
              oe.value.scale < 7 &&
                (oe.value.scale = Number.parseFloat((oe.value.scale * s).toFixed(3)))
        ...
        return (
          ...
          k(() => {
            ...
            ;(!(function () {
              ...
              null == (a = null == (e = U.value) ? void 0 : e.focus) || a.call(e))
          }),
          a({ setActiveItem: _e }),
          (e, a) => (
            w(),
                        ...
                        [
                          y(
                            'div',
                            {
                              class: z(C(J).e('mask')),
                              onClick:
                                a[0] || (a[0] = O((a) => e.hideOnClickModal && pe(), ['self']))
                            },
                            null,
                            2
                          ),
                          ...
                          y(
                            'span',
                            { class: z([C(J).e('btn'), C(J).e('close')]), onClick: pe },
                            [_(C(T), null, { default: I(() => [_(C(A))]), _: 1 })],
                            2
                          ),
                          N(' ARROW '),
                          C(ie)
                              ...
                              R(
                                ...
                                [
                                  y(
                                    ...
                                    [_(C(T), null, { default: I(() => [_(C(E))]), _: 1 })],
                                    2
                                  ),
                                  y(
                                    'span',
                                    { class: z(C(fe)), onClick: ye },
                                    [_(C(T), null, { default: I(() => [_(C(L))]), _: 1 })],
                                    2
                                  )
                                ],
                                64
                            ...
                            [
                              y(
                                ...
                                [
                                  _(
                                    C(T),
                                    { onClick: a[1] || (a[1] = (e) => ze('zoomOut')) },
                                    { default: I(() => [_(C(X))]), _: 1 }
                                  ),
                                  _(
                                    C(T),
                                    { onClick: a[2] || (a[2] = (e) => ze('zoomIn')) },
                                    { default: I(() => [_(C(j))]), _: 1 }
                                  ),
                                  y('i', { class: z(C(J).e('actions__divider')) }, null, 2),
                                  _(
                                    C(T),
                                    { onClick: xe },
                                    { default: I(() => [(w(), x(F(C(le).icon)))]), _: 1 }
                                  ),
                                  y('i', { class: z(C(J).e('actions__divider')) }, null, 2),
                                  _(
                                    C(T),
                                    { onClick: a[3] || (a[3] = (e) => ze('anticlockwise')) },
                                    { default: I(() => [_(C($))]), _: 1 }
                                  ),
                                  _(
                                    C(T),
                                    { onClick: a[4] || (a[4] = (e) => ze('clockwise')) },
                                    { default: I(() => [_(C(B))]), _: 1 }
                                  )
                                ],
                                2
