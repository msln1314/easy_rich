...
const _ = (() => {
    ...
    return {
      ...
      remove: (t) => {
        var n, o
        ;((e = I(e, t)), null == (o = null == (n = e[0]) ? void 0 : n.resume) || o.call(n))
      }
    }
  })(),
  A = () => {
  ...
  j = (e) => new CustomEvent('focus-trap.focusout-prevented', { ...L, detail: e })
var x = a(
  r({
    name: 'ElFocusTrap',
    inheritAttrs: !1,
    ...
    emits: [h, T, 'focusin', 'focusout', 'focusout-prevented', 'release-requested'],
    setup(a, { emit: r }) {
      const i = s()
      let L, P
      const { focusReason: I } =
        ...
        { focusReason: k, lastUserFocusTimestamp: g, lastAutomatedFocusTimestamp: F })
      var x
      ;((x = (e) => {
        a.trapped && !O.paused && r('release-requested', e)
      }),
        e(() => {
          ;(0 === v.length && document.addEventListener('keydown', m), t && v.push(x))
        }),
        n(() => {
          ;((v = v.filter((e) => e !== x)),
      ...
      const O = {
        ...
        q = (e) => {
          ...
          if (O.paused) return
          const { key: t, altKey: n, ctrlKey: s, metaKey: u, currentTarget: c, shiftKey: d } = e,
            { loop: i } = a,
            l = t === o.tab && !n && !s && !u,
          ...
          if (l && f) {
            ...
            if (n && o)
              ...
              const t = j({ focusReason: I.value })
              ;(r('focusout-prevented', t), t.defaultPrevented || e.preventDefault())
            }
          }
        }
      ...
      const D = (e) => {
        ...
        H = (e) => {
          ...
          ;(s && r('focusin', e), O.paused || (a.trapped && (s ? (P = n) : S(P, !0))))
        },
        M = (e) => {
          const t = d(i)
          if (!O.paused && t)
              ...
              p(n) ||
                ...
                setTimeout(() => {
                  if (!O.paused && a.trapped) {
                    const e = j({ focusReason: I.value })
                    ;(r('focusout-prevented', e), e.defaultPrevented || S(P, !0))
                  }
                }, 0)
            } else {
              const n = e.target
            ...
            ;(e.addEventListener(E, D),
              ...
              n.defaultPrevented ||
                l(() => {
                  ...
                  ;(f(n) || (S(n), document.activeElement !== n && (n = 'first')),
                    'first' === n &&
                      ((e, t = !1) => {
                        const n = document.activeElement
                        for (const o of e) if ((S(o, t), document.activeElement !== n)) return
                      })(N(e), !0),
                    (document.activeElement !== t && 'container' !== n) || S(e))
                }))
          }
        }
      }
      function W() {
        ...
        if (e) {
          ...
          const t = new CustomEvent(w, { ...y, detail: { focusReason: I.value } })
          ;(e.addEventListener(w, B),
            e.dispatchEvent(t),
            t.defaultPrevented ||
              ('keyboard' != I.value && g.value > F.value && !e.contains(document.activeElement)) ||
