...
import { _ as Y } from './index-55f4d4a6.js'
import { E as G } from './el-checkbox-77b6829c.js'
const J = '$treeNodeId',
  Q = function (e, t) {
    t &&
      !t[J] &&
      Object.defineProperty(t, J, { value: e.id, enumerable: !1, configurable: !1, writable: !1 })
  },
  V = function (e, t) {
    return e ? t[e] : t[J]
  },
  ...
  Z = (e) => {
    ...
    for (let o = 0, a = e.length; o < a; o++) {
      const a = e[o]
      ;((!0 !== a.checked || a.indeterminate) && ((t = !1), a.disabled || (d = !1)),
        (!1 !== a.checked || a.indeterminate) && (n = !1))
    }
    return { all: t, none: n, allWithoutDisable: d, half: !t && !n }
  },
  ee = function (e) {
    if (0 === e.childNodes.length || e.loading) return
    const { all: t, none: n, half: d } = Z(e.childNodes)
    t
    ...
    const o = e.parent
    o && 0 !== o.level && (e.store.checkStrictly || ee(o))
  },
  te = function (e, t) {
    const n = e.store.props,
      d = e.data || {},
      o = n[t]
    if ('function' == typeof o) return o(d, e)
    if ('string' == typeof o) return d[o]
    if (void 0 === o) {
      const e = d[t]
      return void 0 === e ? '' : e
    }
...
class de {
  constructor(t) {
    ;((this.id = ne++),
      ...
      (this.isCurrent = !1),
      (this.canFocus = !1))
    for (const n in t) e(t, n) && (this[n] = t[n])
    ;((this.level = 0),
      (this.loaded = !1),
      (this.childNodes = []),
      (this.loading = !1),
  ...
  initialize() {
    ...
    if (
      ...
      Array.isArray(this.data) || Q(this, this.data),
      !this.data)
    )
      return
    const n = e.defaultExpandedKeys,
      d = e.key
    ;(d && n && n.includes(this.key) && this.expand(null, e.autoExpandParent),
      d &&
  ...
  setData(e) {
    let t
    ;(Array.isArray(e) || Q(this, e),
      (this.data = e),
      (this.childNodes = []),
      (t = 0 === this.level && Array.isArray(this.data) ? this.data : te(this, 'children') || []))
    for (let n = 0, d = t.length; n < d; n++) this.insertChild({ data: t[n] })
  }
  get label() {
  ...
  insertChild(e, n, d) {
    ...
    if (!(e instanceof de)) {
      if (!d) {
        ...
        t.includes(e.data) || (void 0 === n || n < 0 ? t.push(e.data) : t.splice(n, 0, e.data))
      }
      ;(Object.assign(e, { parent: this, store: this.store }),
        (e = t(new de(e))) instanceof de && e.initialize())
    }
    ;((e.level = this.level + 1),
      void 0 === n || n < 0 ? this.childNodes.push(e) : this.childNodes.splice(n, 0, e),
      this.updateLeafState())
  }
  insertBefore(e, t) {
    let n
  ...
  removeChild(e) {
    const t = this.getChildren() || [],
      n = t.indexOf(e.data)
    n > -1 && t.splice(n, 1)
    const d = this.childNodes.indexOf(e)
    ;(d > -1 &&
      (this.store && this.store.deregisterNode(e), (e.parent = null), this.childNodes.splice(d, 1)),
      this.updateLeafState())
  }
  removeChildByData(e) {
    let t = null
  ...
  expand(e, t) {
    ...
    this.shouldLoadData()
      ? this.loadData((e) => {
          Array.isArray(e) &&
            (this.checked ? this.setChecked(!0, !0) : this.store.checkStrictly || ee(this), n())
        })
      : n()
  }
  ...
  setChecked(e, t, n, d) {
    ...
    if (!this.shouldLoadData() || this.store.checkDescendants) {
      const { all: n, allWithoutDisable: o } = Z(this.childNodes)
      ...
      const a = () => {
        if (t) {
          ...
          for (let r = 0, s = n.length; r < s; r++) {
            const o = n[r]
            d = d || !1 !== e
            const a = o.disabled ? o.checked : d
            o.setChecked(a, t, !0, d)
          }
          const { half: o, all: a } = Z(n)
  ...
  updateChildren() {
    ...
    ;(e.forEach((e, o) => {
      const a = e[J]
      !!a && t.findIndex((e) => e[J] === a) >= 0
        ? (n[a] = { index: o, data: e })
        : d.push({ index: o, data: e })
    }),
      this.store.lazy ||
        t.forEach((e) => {
          n[e[J]] || this.removeChildByData(e)
        }),
      d.forEach(({ index: e, data: t }) => {
...
class oe {
  ...
  initialize() {
    if (
      ((this.root = new de({ data: this.data, store: this })),
  ...
  filter(e) {
    const t = this.filterNodeMethod,
      ...
      d = function (o) {
        ...
        if (
          (a.forEach((n) => {
            ;((n.visible = t.call(n, e, n.data, n)), d(n))
          }),
          !o.visible && a.length)
        ) {
          let e = !0
  ...
  _getAllNodes() {
    const t = [],
      n = this.nodesMap
    for (const d in n) e(n, d) && t.push(n[d])
    return t
  }
  updateChildren(e, t) {
  ...
  _setCheckedKeys(e, t = !1, n) {
    const d = this._getAllNodes().sort((e, t) => t.level - e.level),
      o = Object.create(null),
      a = Object.keys(n)
    d.forEach((e) => e.setChecked(!1, !1))
    for (let r = 0, s = d.length; r < s; r++) {
      const n = d[r],
        s = n.data[e].toString()
      if (!a.includes(s)) {
        n.checked && !o[s] && n.setChecked(!1, !1)
        continue
      }
      let i = n.parent
      for (; i && i.level > 0; ) ((o[i.data[e]] = !0), (i = i.parent))
    ...
    setup(e) {
      ...
      return () => {
        ...
        return e.renderContent
          ? e.renderContent(s, { _self: n, node: o, data: a, store: r })
          : d.ctx.slots.default
            ? d.ctx.slots.default({ node: o, data: a })
            : s('span', { class: t.be('node', 'label') }, [o.label])
      }
    }
  }),
  [
...
const ie = o({
    name: 'ElTreeNode',
    components: { ElCollapseTransition: Y, ElCheckbox: G, NodeContent: ae, ElIcon: u, Loading: p },
    props: {
      node: { type: de, default: () => ({}) },
    ...
    setup(e, t) {
      const n = a('tree'),
        ...
        N = r(se),
        v = f()
      ;(i('NodeInstance', v), e.node.expanded && ((s.value = !0), (c.value = !0)))
      const C = o.props.children || 'children'
      ;(g(
        () => {
          const t = e.node.data[C]
          return t && [...t]
        },
        () => {
        ...
        g(
          () => e.node.expanded,
          (e) => {
            ;(y(() => (s.value = e)), e && (c.value = !0))
          }
        ))
      const x = (t, n) => {
          ;((h.value === t && u.value === n) || o.ctx.emit('check-change', e.node.data, t, n),
            (h.value = t),
            (u.value = n))
        },
        m = () => {
          e.node.isLeaf ||
            (s.value
              ? (o.ctx.emit('node-collapse', e.node.data, e.node, v), e.node.collapse())
              : (e.node.expand(), t.emit('node-expand', e.node.data, e.node, v)))
        },
        b = (t, n) => {
      ...
      return {
        ...
        oldChecked: h,
        oldIndeterminate: u,
        getNodeKey: (e) => V(o.props.nodeKey, e.data),
        getNodeClass: (t) => {
        ...
        handleClick: (t) => {
          ;(X(o.store, o.ctx.emit, () => o.store.value.setCurrentNode(e.node)),
            (o.currentNode.value = e.node),
            o.props.expandOnClickNode && m(),
            o.props.checkOnClickNode &&
              !e.node.disabled &&
              b(null, { target: { checked: !e.node.checked } }),
            o.ctx.emit('node-click', e.node.data, e.node, v, t))
        },
        handleContextMenu: (t) => {
          ;(o.instance.vnode.props.onNodeContextmenu && (t.stopPropagation(), t.preventDefault()),
            o.ctx.emit('node-contextmenu', t, e.node.data, e.node, v))
        },
        handleExpandIconClick: m,
        handleCheckChange: b,
        handleChildNodeExpand: (e, t, n) => {
          ;(d(t), o.ctx.emit('node-expand', e, t, n))
        },
        handleDragStart: (t) => {
          o.props.draggable && N.treeNodeDragStart({ event: t, treeNode: e })
        },
        handleDragOver: (t) => {
          ;(t.preventDefault(),
            o.props.draggable &&
              N.treeNodeDragOver({ event: t, treeNode: { $el: p.value, node: e.node } }))
        },
        handleDrop: (e) => {
          e.preventDefault()
        },
        handleDragEnd: (e) => {
          o.props.draggable && N.treeNodeDragEnd(e)
        },
        CaretRight: k
      }
    }
  }),
  le = ['aria-expanded', 'aria-disabled', 'aria-checked', 'draggable', 'data-key'],
  ce = ['aria-expanded']
var he = d(
  o({
    name: 'ElTree',
    components: {
      ElTreeNode: d(ie, [
        [
          'render',
          function (e, t, n, d, o, a) {
            const r = N('el-icon'),
              s = N('el-checkbox'),
              i = N('loading'),
              l = N('node-content'),
              c = N('el-tree-node'),
              h = N('el-collapse-transition')
            return v(
              (x(),
              m(
                'div',
                {
                  ...
                  onClick:
                    t[1] || (t[1] = S((...t) => e.handleClick && e.handleClick(...t), ['stop'])),
                  onContextmenu:
                    t[2] || (t[2] = (...t) => e.handleContextMenu && e.handleContextMenu(...t)),
                  onDragstart:
                    t[3] ||
                    (t[3] = S((...t) => e.handleDragStart && e.handleDragStart(...t), ['stop'])),
                  onDragover:
                    t[4] ||
                    (t[4] = S((...t) => e.handleDragOver && e.handleDragOver(...t), ['stop'])),
                  onDragend:
                    t[5] ||
                    (t[5] = S((...t) => e.handleDragEnd && e.handleDragEnd(...t), ['stop'])),
                  onDrop: t[6] || (t[6] = S((...t) => e.handleDrop && e.handleDrop(...t), ['stop']))
                },
                [
                  b(
                    'div',
                    {
                      class: w(e.ns.be('node', 'content')),
                      style: L({ paddingLeft: (e.node.level - 1) * e.tree.props.indent + 'px' })
                    },
                    [
                      e.tree.props.icon || e.CaretRight
                        ? (x(),
                          E(
                            ...
                            {
                              default: D(() => [(x(), E(K(e.tree.props.icon || e.CaretRight)))]),
                              _: 1
                            },
                            8,
                            ['class', 'onClick']
                      ...
                      e.node.loading
                        ? (x(),
                          E(
                            ...
                            {
                              key: 2,
                              class: w([e.ns.be('node', 'loading-icon'), e.ns.is('loading')])
                            },
                            { default: D(() => [B(i)]), _: 1 },
                            8,
                            ['class']
                        ...
                        : A('v-if', !0),
                      B(l, { node: e.node, 'render-content': e.renderContent }, null, 8, [
                        'node',
                        'render-content'
                      ])
                    ],
    ...
    setup(e, t) {
      ...
      o.value.initialize()
      const r = l(o.value.root),
        s = l(null),
        u = l(null),
        p = l(null),
        { broadcastExpanded: y } = re(e),
        { dragState: k } = (function ({ props: e, ctx: t, el$: n, dropIndicator$: d, store: o }) {
          const r = a('tree'),
            s = l({
              showDropIndicator: !1,
              draggingNode: null,
          ...
          return (
            i(se, {
              treeNodeDragStart: ({ event: n, treeNode: d }) => {
                if ('function' == typeof e.allowDrag && !e.allowDrag(d.node))
                  return (n.preventDefault(), !1)
                n.dataTransfer.effectAllowed = 'move'
                try {
                  n.dataTransfer.setData('text/plain', '')
                } catch (o) {}
                ;((s.value.draggingNode = d), t.emit('node-drag-start', d.node, n))
              },
              treeNodeDragOver: ({ event: o, treeNode: a }) => {
                const i = a,
                  l = s.value.dropNode
                l && l.node.id !== i.node.id && c(l.$el, r.is('drop-inner'))
                ...
                ;('function' == typeof e.allowDrop &&
                  ((p = e.allowDrop(u.node, i.node, 'prev')),
                  (y = f = e.allowDrop(u.node, i.node, 'inner')),
                  (g = e.allowDrop(u.node, i.node, 'next'))),
                  (o.dataTransfer.dropEffect = f || p || g ? 'move' : 'none'),
                  (p || f || g) &&
                    (null == l ? void 0 : l.node.id) !== i.node.id &&
                    (l && t.emit('node-drag-leave', u.node, l.node, o),
                    t.emit('node-drag-enter', u.node, i.node, o)),
                  (p || f || g) && (s.value.dropNode = i),
                  i.node.nextSibling === u.node && (g = !1),
                  i.node.previousSibling === u.node && (p = !1),
                  i.node.contains(u.node, !1) && (f = !1),
                  (u.node === i.node || u.node.contains(i.node)) && ((p = !1), (f = !1), (g = !1)))
                const k = i.$el
                    .querySelector(`.${r.be('node', 'content')}`)
                    .getBoundingClientRect(),
                  N = n.value.getBoundingClientRect()
                let v
                const C = p ? (f ? 0.25 : g ? 0.45 : 1) : -1,
                  x = g ? (f ? 0.75 : p ? 0.55 : 0) : 1
                let m = -9999
                const b = o.clientY - k.top
                v = b < k.height * C ? 'before' : b > k.height * x ? 'after' : f ? 'inner' : 'none'
                const E = i.$el
                    .querySelector(`.${r.be('node', 'expand-icon')}`)
                    .getBoundingClientRect(),
                  D = d.value
                ;('before' === v ? (m = E.top - N.top) : 'after' === v && (m = E.bottom - N.top),
                  (D.style.top = `${m}px`),
                  (D.style.left = E.right - N.left + 'px'),
                  'inner' === v ? h(i.$el, r.is('drop-inner')) : c(i.$el, r.is('drop-inner')),
                  (s.value.showDropIndicator = 'before' === v || 'after' === v),
                  (s.value.allowDrop = s.value.showDropIndicator || y),
                  (s.value.dropType = v),
                  t.emit('node-drag-over', u.node, i.node, o))
              },
              treeNodeDragEnd: (e) => {
                const { draggingNode: n, dropType: d, dropNode: a } = s.value
                if ((e.preventDefault(), (e.dataTransfer.dropEffect = 'move'), n && a)) {
                  const s = { data: n.node.data }
                  ;('none' !== d && n.node.remove(),
                    'before' === d
                      ? a.node.parent.insertBefore(s, a.node)
                      : 'after' === d
                        ? a.node.parent.insertAfter(s, a.node)
                        : 'inner' === d && a.node.insertChild(s),
                    'none' !== d && o.value.registerNode(s),
                    c(a.$el, r.is('drop-inner')),
                    t.emit('node-drag-end', n.node, a.node, d, e),
                    'none' !== d && t.emit('node-drop', n.node, a.node, d, e))
                }
                ;(n && !a && t.emit('node-drag-end', n.node, null, d, e),
        ...
        })({ props: e, ctx: t, el$: u, dropIndicator$: p, store: o })
      !(function ({ el$: e }, t) {
        const n = a('tree'),
          d = q([]),
          o = q([])
        ;(M(() => {
          ...
          z(() => {
            ;((d.value = Array.from(e.value.querySelectorAll('[role=treeitem]'))),
          ...
          I(e, 'keydown', (o) => {
            ...
            const r = o.code
            d.value = Array.from(e.value.querySelectorAll(`.${n.is('focusable')}[role=treeitem]`))
            const s = d.value.indexOf(a)
            let i
            if ([F.up, F.down].includes(r)) {
              if ((o.preventDefault(), r === F.up)) {
                i = -1 === s ? 0 : 0 !== s ? s - 1 : d.value.length - 1
                const e = i
                for (; !t.value.getNode(d.value[i].dataset.key).canFocus; ) {
                  if ((i--, i === e)) {
                    i = -1
                    break
                  }
                  i < 0 && (i = d.value.length - 1)
                }
              } else {
                i = -1 === s ? 0 : s < d.value.length - 1 ? s + 1 : 0
                const e = i
                for (; !t.value.getNode(d.value[i].dataset.key).canFocus; ) {
                  if ((i++, i === e)) {
                    i = -1
                  ...
                  i >= d.value.length && (i = 0)
                }
              }
              ;-1 !== i && d.value[i].focus()
            }
            ;[F.left, F.right].includes(r) && (o.preventDefault(), a.click())
            const l = a.querySelector('[type="checkbox"]')
            ;[F.enter, F.space].includes(r) && l && (o.preventDefault(), l.click())
          }))
        const r = () => {
          var t
          ;((d.value = Array.from(
          ...
          a.length
            ...
            : null == (t = d.value[0]) || t.setAttribute('tabindex', '0')
        }
      })({ el$: u }, o)
      const N = H(() => {
        const { childNodes: e } = r.value
      ...
      return (
        i('RootTree', { ctx: t, props: e, store: o, root: r, currentNode: s, instance: f() }),
        i(P, void 0),
        {
          ns: d,
          store: o,
          ...
          getNodeKey: (t) => V(e.nodeKey, t.data),
          getNodePath: (t) => {
            ...
            const d = [n.data]
            let a = n.parent
            for (; a && a !== r.value; ) (d.push(a.data), (a = a.parent))
            return d.reverse()
          },
          ...
          handleNodeExpand: (e, n, d) => {
            ;(y(n), t.emit('node-expand', e, n, d))
          },
          ...
          m(
            'div',
            {
              ...
              class: w([
                ...
                e.ns.is('drop-inner', 'inner' === e.dragState.dropType),
            ...
            [
              ...
              e.isEmpty
                ? (x(),
                  m(
                    'div',
                    { key: 0, class: w(e.ns.e('empty-block')) },
                    [
                      U(e.$slots, 'empty', {}, () => {
                        var t
                        return [
                          b(
                            ...
                            W(null != (t = e.emptyText) ? t : e.t('el.tree.emptyText')),
                            3
                          )
                        ]
                      })
                ...
                : A('v-if', !0),
              v(b('div', { ref: 'dropIndicator$', class: w(e.ns.e('drop-indicator')) }, null, 2), [
                [C, e.dragState.showDropIndicator]
              ])
            ],
            2
          )
