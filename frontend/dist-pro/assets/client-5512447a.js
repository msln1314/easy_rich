...
const a = (a) => t.get({ url: '/iot/clients', params: a }),
  ...
  p = (a, i) => t.post({ url: '/iot/clients/export/excel', params: a, data: i }),
  u = () => t.get({ url: '/iot/clients/download/import/template' }),
  n = (a) => t.post({ url: '/iot/clients/import', headersType: 'multipart/form-data', data: a })
export { r as a, a as b, p as c, s as d, i as e, e as f, d as g, l as h, n as i, u as j, o as p }
