import { a9 as t, aa as e } from './index-820a519e.js'
var r = { exports: {} }
const n = e(
  (r.exports = (function () {
    var t = 1e3,
      ...
      y = {
        ...
        p: function (t) {
          return (
            { M: c, y: h, w: o, d: a, D: d, h: u, m: i, s: s, ms: n, Q: f }[t] ||
            String(t || '')
              .toLowerCase()
              .replace(/s$/, '')
          )
        ...
        return (
          ...
          (v.startOf = function (t, e) {
            var r = this,
              ...
              f = O.p(t),
              $ = function (t, e) {
                var s = O.w(r.$u ? Date.UTC(r.$y, e, t) : new Date(r.$y, e, t), r)
          ...
          (v.add = function (n, f) {
            ...
            var l = O.p(f),
              M = function (t) {
                var e = w($)
                return O.w(e.date(e.date() + Math.round(t * n)), $)
              }
