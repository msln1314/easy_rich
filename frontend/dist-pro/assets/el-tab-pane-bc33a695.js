...
import { c as W } from './strings-ed83d626.js'
import { U as X } from './event-5568c9d8.js'
import { f as Y } from './vnode-06a99f10.js'
const I = (t, l) => {
    const s = {},
      o = e([])
    return {
            ...
            return (
              t.tabs.every((s) => {
                ...
                return (
                  'width' === o &&
                    (t.tabs.length > 1 &&
                      (a -= Number.parseFloat(d.paddingLeft) + Number.parseFloat(d.paddingRight)),
  ...
  se = o({
    ...
    setup(e, { expose: a, emit: t }) {
      ...
      const o = u('tabs'),
        ...
        F = d(!1),
        _ = d(!0),
        j = w(() => (['top', 'bottom'].includes(s.props.tabPosition) ? 'width' : 'height')),
        L = w(() => ({ transform: `translate${'width' === j.value ? 'X' : 'Y'}(-${A.value}px)` })),
        q = () => {
          if (!f.value) return
        ...
        D = (e) => {
          ...
          let i
          ;((i =
            a === s || a === t ? (0 === r ? n.length - 1 : r - 1) : r < n.length - 1 ? r + 1 : 0),
      ...
      return (
        c(b, (e) => {
          'hidden' === e ? (_.value = !1) : 'visible' === e && setTimeout(() => (_.value = !0), 50)
        }),
        c(m, (e) => {
        ...
        $(() => setTimeout(() => z(), 0)),
        k(() => V()),
        a({ scrollToActiveTab: z, removeFocus: M }),
        c(
          () => e.panes,
          () => l.update(),
          { flush: 'post', deep: !0 }
        ...
        () => {
          const a = R.value
              ? [
                  P(
                    'span',
                    { class: [o.e('nav-prev'), o.is('disabled', !R.value.prev)], onClick: q },
                    [P(N, null, { default: () => [P(T, null, null)] })]
                  ),
                  P(
                    'span',
                    { class: [o.e('nav-next'), o.is('disabled', !R.value.next)], onClick: K },
            ...
            l = e.panes.map((a, l) => {
              ...
              const b = p
                  ? P(
                      N,
                      { class: 'is-icon-close', onClick: (e) => t('tabRemove', a, e) },
              ...
              return P(
                'div',
                {
                  ...
                  onKeydown: (e) => {
                    !p || (e.code !== E.delete && e.code !== E.backspace) || t('tabRemove', a, e)
                  }
                },
                [m, b]
              )
          ...
          return P(
            ...
            {
              ref: y,
              class: [o.e('nav-wrap'), o.is('scrollable', !!R.value), o.is(s.props.tabPosition)]
            },
            [
              a,
                ...
                P(
                  'div',
                  {
                    class: [
                      o.e('nav'),
                      o.is(s.props.tabPosition),
                      o.is('stretch', e.stretch && ['top', 'bottom'].includes(s.props.tabPosition))
                    ],
                    ref: h,
                    style: L.value,
                    role: 'tablist',
                  ...
                  [e.type ? null : P(ae, { ref: g, tabs: [...e.panes] }, null), l]
                )
              ])
            ]
          )
...
var re = o({
  ...
  setup(e, { emit: a, slots: t, expose: l }) {
    ...
    const r = u('tabs'),
      ...
      m = d(),
      f = d(null != (o = null != (s = e.modelValue) ? s : e.activeName) ? o : '0'),
      h = async (t) => {
        var l, s, o
        if (f.value !== t && !j(t))
          try {
            !1 !== (await (null == (l = e.beforeLeave) ? void 0 : l.call(e, t, f.value))) &&
              (((e) => {
                ;((f.value = e), a(X, e), a('tabChange', e))
              })(t),
              null == (o = null == (s = m.value) ? void 0 : s.removeFocus) || o.call(s))
          } catch (n) {}
      },
      y = (e, t, l) => {
      ...
      g = (e, t) => {
        e.props.disabled ||
          j(e.props.name) ||
          (t.stopPropagation(), a('edit', e.props.name, 'remove'), a('tabRemove', e.props.name))
      },
      C = () => {
        ...
        const a =
            e.editable || e.addable
              ? P(
                  ...
                  [P(N, { class: r.is('icon-plus') }, { default: () => [P(F, null, null)] })]
                )
              : null,
        ...
        return P(
          'div',
          {
            class: [
              r.b(),
              r.m(e.tabPosition),
              { [r.m('card')]: 'card' === e.type, [r.m('border-card')]: 'border-card' === e.type }
            ]
          },
