...
import { e as a, o as t, j as r, x as l, k as o, J as n } from './index-820a519e.js'
import './echarts-ef988edf.js'
const s = { class: 'echarts' },
  i = n(
    a({
      ...
      setup(a) {
          ...
          i = {
            ...
            series: [
              ...
              },
              {
                ...
                startAngle: 105,
                data: [
                  { value: 30, name: '', itemStyle: { color: 'transparent' } },
                  { value: 5, name: '', itemStyle: { color: 'transparent' } },
                  { value: 65, name: 'ddd', itemStyle: { color: '#ffffff' } }
                ],
                silent: !0,
                labelLine: { show: !1 },
                label: { show: !1 }
                ...
                data: [
                  {
                    value: 25,
                    name: '1',
                    itemStyle: { color: 'transparent', borderWidth: 4, borderColor: '#ffffff' }
                  },
                  { value: 75, name: '2', itemStyle: { color: 'transparent' } }
                ],
                selectedOffset: 10,
                silent: !0,
                labelLine: { show: !1 },
                  ...
                  .map((e, a) =>
                    a % 3 == 0
                      ? {
                          name: (a + 1).toString(),
                          value: 10,
                          itemStyle: { color: '#fff', borderWidth: 0, borderColor: 'rgba(0,0,0,0)' }
                        }
                      : {
                          name: (a + 1).toString(),
                          value: 25,
        ...
        return (a, n) => (t(), r('div', s, [l(o(e), { option: i, resize: !1 })]))
      }
    }),
    [['__scopeId', 'data-v-172fe8bc']]
  )
export { i as default }
