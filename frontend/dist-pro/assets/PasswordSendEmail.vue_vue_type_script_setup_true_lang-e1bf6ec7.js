        ...
        return (
          ...
          t('div', null, [
            ...
            l(
              ...
              {
                default: i(() => [
                  l(d(m), { prop: 'id', label: '用户编号', width: '100', align: 'center' }),
                  l(d(m), { prop: 'name', label: '姓名', width: '120', align: 'center' }),
                  l(d(m), { prop: 'email', label: '邮箱', width: '200', align: 'center' }),
                  l(
                    d(m),
                    {
                  ...
                  l(d(m), { prop: 'send_sms_msg', label: '描述', align: 'center' }),
                  l(
                    d(m),
                      ...
                      default: i((e) => [
                        l(
                          d(y),
                          {
                            title: '确认移除吗?',
                            onConfirm: (a) => {
                              return ((s = e.$index), void b.value.splice(s, 1))
                              var s
                            }
                          },
                          {
