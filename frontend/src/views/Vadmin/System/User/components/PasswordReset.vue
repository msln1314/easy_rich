...
import { postUsersInitPasswordReserApi } from '@/api/system/user'
...
const initPassword = async () => {
  ...
  try {
    const res = await postUsersInitPasswordReserApi(ids)
    if (res) {
...
<template>
  <div>
    ...
    >
      ...
      <ElTableColumn prop="phone" label="手机" width="200" align="center" />
